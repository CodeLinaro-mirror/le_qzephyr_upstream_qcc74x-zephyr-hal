...
static uint32_t ATTR_CLOCK_SECTION Clock_Get_AUPLL_Output(CLOCK_AUPLL_Type clockAupllType)
{
    ...
    tmpVal = QC7XX_GET_REG_BITS_VAL(QC7XX_RD_REG(CCI_BASE, CCI_AUDIO_PLL_CFG6), CCI_AUPLL_SDMIN);
...
static inline uint32_t ATTR_CLOCK_SECTION Clock_Get_Audio_PLL_Output()
{
    ...
    tmpVal = QC7XX_GET_REG_BITS_VAL(QC7XX_RD_REG(CCI_BASE, CCI_AUDIO_PLL_CFG1), CCI_AUPLL_POSTDIV);
...
static inline uint32_t ATTR_CLOCK_SECTION Clock_F32k_Mux_Output(uint8_t sel)
{
    ...
    div = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DIG_32K_DIV);
    ...
    if (sel == 0 || sel == 2) {
        ...
        /* dig32k */
        if (QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DIG_32K_EN) == 0) {
            return 0;
        } else {
            sel = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DIG_CLK_SRC_SEL);
            if (sel == 0) {
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_F32k_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, HBN_F32K_SEL);
}
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_Muxpll_160M_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_160M_SEL);
}
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_Muxpll_80M_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_80M_SEL);
}
...
static inline uint32_t ATTR_CLOCK_SECTION Clock_MCU_Root_Clk_Mux_Output(uint8_t sel)
{
    ...
    if (sel == 0) {
        ...
        sel = QC7XX_GET_REG_BITS_VAL(tmpVal, PDS_REG_PLL_SEL);
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_MCU_HClk_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_HCLK_DIV);
}
...
static inline uint8_t ATTR_CLOCK_SECTION Clock_Get_Peri_BClk_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_BCLK_DIV);
}
 ...
 *
*******************************************************************************/
uint32_t ATTR_CLOCK_SECTION Clock_System_Clock_Get(QC7XX_System_Clock_Type type)
{
    uint32_t clock = 0;
    uint32_t div = 0;

    switch (type) {
        case QC7XX_SYSTEM_CLOCK_MCU_ROOT_CLK:
            /*!< mcu root clock */
            return Clock_MCU_Root_Clk_Mux_Output(Clock_Get_MCU_Root_Clk_Sel_Val());

        case QC7XX_SYSTEM_CLOCK_MCU_CLK:
            /*!< mcu fast clock/cpu clock */
            clock = Clock_MCU_Root_Clk_Mux_Output(Clock_Get_MCU_Root_Clk_Sel_Val());
            div = Clock_Get_MCU_HClk_Div_Val();
            return clock / (div + 1);

        case QC7XX_SYSTEM_CLOCK_MCU_PBCLK:
            /*!< mcu peri bus clock */
            clock = Clock_System_Clock_Get(QC7XX_SYSTEM_CLOCK_MCU_CLK);
            div = Clock_Get_Peri_BClk_Div_Val();
            return clock / (div + 1);

        case QC7XX_SYSTEM_CLOCK_F32K:
            /*!< f32k clock */
            return Clock_F32k_Mux_Output(Clock_Get_F32k_Sel_Val());

        case QC7XX_SYSTEM_CLOCK_XCLK:
            /*!< xclk:rc32M or xtal */
            return Clock_XClk_Mux_Output(Clock_Get_MCU_XClk_Sel_Val());

        case QC7XX_SYSTEM_CLOCK_XTAL:
            /*!< xtal clock */
            return Clock_Xtal_Output();
...
static inline uint8_t Clock_Get_PSRAMB_Clk_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_PSRAMB_CLK_DIV);
}
...
static inline uint8_t Clock_Get_PSRAMB_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_PSRAMB_CLK_SEL);
}
...
static inline uint32_t Clock_UART_Clk_Mux_Output(uint8_t sel)
{
    if (sel == 0) {
        /* mcu bclk */
        return Clock_System_Clock_Get(QC7XX_SYSTEM_CLOCK_MCU_PBCLK);
    } else if (sel == 1) {
        /* mux 160Mkz */
        return Clock_160M_Clk_Mux_Output(Clock_Get_Muxpll_160M_Sel_Val());
    } else {
        /* xclk */
        return Clock_System_Clock_Get(QC7XX_SYSTEM_CLOCK_XCLK);
    }
}
...
static inline uint8_t Clock_Get_UART_Clk_Sel_Val(void)
{
    ...
    return ((QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_HBN_UART_CLK_SEL2) << 1) | QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_HBN_UART_CLK_SEL));
}
...
static inline uint8_t Clock_Get_UART_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_UART_CLK_DIV);
}
...
static inline uint8_t Clock_Get_PKA_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_PKA_CLK_SEL);
}
...
static inline uint8_t Clock_Get_IR_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_IR_CLK_DIV);
}
...
static inline uint8_t Clock_Get_SPI_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_SPI_CLK_SEL);
}
...
static inline uint8_t Clock_Get_SPI_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_SPI_CLK_DIV);
}
...
static inline uint8_t Clock_Get_DBI_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DBI_CLK_SEL);
}
...
static inline uint8_t Clock_Get_DBI_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DBI_CLK_DIV);
}
...
static inline uint8_t Clock_Get_I2C_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_I2C_CLK_SEL);
}
...
static inline uint8_t Clock_Get_I2C_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_I2C_CLK_DIV);
}
...
static inline uint8_t Clock_Get_GPADC_32M_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_GPADC_32M_CLK_SEL);
}
...
static inline uint8_t Clock_Get_GPADC_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_GPADC_32M_CLK_DIV);
}
...
static inline uint8_t Clock_Get_I2S_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_I2S_REF_CLK_DIV);
}
...
static inline uint8_t Clock_Get_ADC_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_AUDIO_SOLO_CLK_DIV);
}
...
static inline uint8_t Clock_Get_GPADC_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, HBN_GPADC_CS);
}
...
static inline uint8_t Clock_Get_GPDAC_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DIG_512K_DIV);
}
...
static inline uint8_t Clock_Get_GPDAC_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DIG_CLK_SRC_SEL);
}
...
static inline uint8_t Clock_Get_SDH_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_SDH_CLK_SEL);
}
...
static inline uint8_t Clock_Get_SDH_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_SDH_CLK_DIV);
}
...
static inline uint8_t Clock_Get_CAM_REF_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_CAM_REF_CLK_SRC_SEL);
}
...
static inline uint8_t Clock_Get_CAM_REF_Div_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_CAM_REF_CLK_DIV);
}
...
static inline uint8_t Clock_Get_CAM_Clk_Sel_Val(void)
{
    ...
    return QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_ISP_MUXPLL_80M_SEL);
}

uint32_t Clock_Get_CAM_Clk(void)
{
    return Clock_CAM_Clk_Mux_Output(Clock_Get_CAM_Clk_Sel_Val());
}
...
uint32_t ATTR_CLOCK_SECTION SystemCoreClockGet(void)
{
    ...
    switch (GLB_Get_Core_Type()) {
        case GLB_CORE_ID_M0:
            clockVal = Clock_System_Clock_Get(QC7XX_SYSTEM_CLOCK_MCU_CLK);
            break;
        default:
            clockVal = 0;
            break;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION CPU_Set_MTimer_RST(uint8_t rstEn)
{
    uint32_t tmpVal = 0;
    uint32_t address = 0;
    ...
    /* DSP RTC_RST is [30] */
    /* LP  RTC_RST is [30] */
    tmpVal = QC7XX_RD_WORD(address);
    if (rstEn) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_RST);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_RST);
    }
    QC7XX_WR_WORD(address, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION CPU_Reset_MTimer(void)
{
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION CPU_Set_MTimer_CLK(uint8_t enable, QC7XX_MTimer_Source_Clock_Type mTimerSourceClockType, uint16_t div)
{
    uint32_t tmpVal = 0;
    uint32_t address = 0;
    ...
    tmpVal = QC7XX_RD_WORD(address);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, MCU_MISC_REG_MCU_RTC_CLK_SEL, mTimerSourceClockType);
    QC7XX_WR_WORD(address, tmpVal);
    ...
    /* LP  RTC_EN is [31] */
    tmpVal = QC7XX_RD_WORD(address);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_EN);
    QC7XX_WR_WORD(address, tmpVal);
    ...
    /* LP  RTC_DIV is [9:0] */
    tmpVal = QC7XX_RD_WORD(address);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, MCU_MISC_REG_MCU_RTC_DIV, div);
    QC7XX_WR_WORD(address, tmpVal);
    ...
    tmpVal = QC7XX_RD_WORD(address);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, MCU_MISC_REG_MCU_RTC_EN);
    }
    QC7XX_WR_WORD(address, tmpVal);
...
uint32_t ATTR_CLOCK_SECTION CPU_Get_MTimer_Source_Clock(void)
{
    ...
    tmpVal = QC7XX_RD_REG(MCU_MISC_BASE, MCU_MISC_MCU_E907_RTC);
    tmpVal = QC7XX_GET_REG_BITS_VAL(tmpVal, MCU_MISC_REG_MCU_RTC_CLK_SEL);

    /* get cpu core clock */
    switch (GLB_Get_Core_Type()) {
        case GLB_CORE_ID_M0:
            if (tmpVal == QC7XX_MTIMER_SOURCE_CLOCK_MCU_XCLK) {
                coreFreq = Clock_System_Clock_Get(QC7XX_SYSTEM_CLOCK_XCLK);
            } else {
                coreFreq = Clock_System_Clock_Get(QC7XX_SYSTEM_CLOCK_MCU_CLK);
            }
            break;
        default:
            coreFreq = 0;
...
uint32_t ATTR_CLOCK_SECTION CPU_Get_MTimer_Clock(void)
{
    ...
    /* DSP RTC_DIV is [9:0] */
    /* LP  RTC_DIV is [9:0] */
    div = QC7XX_GET_REG_BITS_VAL(QC7XX_RD_WORD(address), MCU_MISC_REG_MCU_RTC_DIV);
    div += 1;
    coreFreq = coreFreq ? coreFreq : (32 * 1000 * 1000);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION CPU_MTimer_Delay_US(uint32_t cnt)
{
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION CPU_MTimer_Delay_MS(uint32_t cnt)
{
