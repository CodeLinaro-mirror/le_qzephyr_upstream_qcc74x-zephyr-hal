...
static QC7XX_Err_Type GLB_Get_And_Clr_First_Set_From_U64(uint64_t *val, uint32_t *bit);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_MCU_Muxpll_160M_Sel(uint8_t clkSel)
{
    uint32_t tmpVal;

    CHECK_PARAM(IS_GLB_MCU_MUXPLL_160M_CLK_SEL_TYPE(clkSel));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_160M_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG1, tmpVal);
...
uint8_t ATTR_CLOCK_SECTION GLB_Get_MCU_Muxpll_160M_Sel(void)
{
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG1);
    return (uint8_t)(QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_160M_SEL));
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_MCU_Muxpll_80M_Sel(uint8_t clkSel)
{
    uint32_t tmpVal;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_80M_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG1, tmpVal);
...
uint8_t ATTR_CLOCK_SECTION GLB_Get_MCU_Muxpll_80M_Sel(void)
{
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG1);
    return (uint8_t)(QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_TOP_MUXPLL_80M_SEL));
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_ISP_Muxpll_80M_Sel(uint8_t clkSel)
{
    uint32_t tmpVal;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_ISP_MUXPLL_80M_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG1, tmpVal);
...
uint8_t ATTR_CLOCK_SECTION GLB_Get_ISP_Muxpll_80M_Sel(void)
{
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG1);
    return (uint8_t)(QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_REG_ISP_MUXPLL_80M_SEL));
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Power_On_XTAL_And_PLL_CLK(uint8_t xtalType, uint8_t pllType)
{
    uint32_t tmpVal;
    uint8_t mcuXclkSel;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SYS_CFG0);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_PLL_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_SYS_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Power_Off_WIFIPLL(void)
{
    ...
    /* cfg0 : pu_wifipll=0 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_PU_WIFIPLL, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);

    /* cfg0 : pu_wifipll_sfreg=0 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_PU_WIFIPLL_SFREG, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_WIFIPLL_Ref_Clk_Sel(uint8_t refClk)
{
    uint32_t REG_PLL_BASE_ADDRESS = 0;
    uint32_t tmpVal = 0;
    ...
    /* xxxpll_refclk_sel */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 1);
    if (GLB_PLL_REFCLK_XTAL == refClk) {
        /* wifipll_refclk_sel different from other's pll, 1 means xtal */
        tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_REFCLK_SEL, 1);
    } else {
        tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_REFCLK_SEL, refClk);
    }
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 1, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Power_On_WIFIPLL(const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable)
{
    uint32_t REG_PLL_BASE_ADDRESS = 0;
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_REFDIV_RATIO, cfg->basicCfg->clkpllRefdivRatio);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 1, tmpVal);

    /* cfg2:Set wifipll_int_frac_sw,wifipll_icp_1u,wifipll_icp_5u */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 2);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_INT_FRAC_SW, cfg->basicCfg->clkpllIntFracSw);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_ICP_1U, cfg->basicCfg->clkpllIcp1u);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_ICP_5U, cfg->basicCfg->clkpllIcp5u);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 2, tmpVal);

    /* cfg3:Set wifipll_rz,wifipll_cz,wifipll_c3,wifipll_r4_short,wifipll_r4_en */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 3);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_RZ, cfg->basicCfg->clkpllRz);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_CZ, cfg->basicCfg->clkpllCz);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_C3, cfg->basicCfg->clkpllC3);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_R4_SHORT, cfg->basicCfg->clkpllR4Short);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_C4_EN, cfg->basicCfg->clkpllC4En);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 3, tmpVal);

    /* cfg4:Set wifipll_sel_sample_clk */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 4);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_SEL_SAMPLE_CLK, cfg->basicCfg->clkpllSelSampleClk);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 4, tmpVal);

    /* cfg5:Set wifipll_vco_speed */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 5);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_VCO_SPEED, cfg->basicCfg->clkpllVcoSpeed);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 5, tmpVal);

    /* cfg6:Set wifipll_sdm_bypass,wifipll_sdmin */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 6);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_SDM_CTRL_HW, cfg->basicCfg->clkpllSdmCtrlHw);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_SDM_BYPASS, cfg->basicCfg->clkpllSdmBypass);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_SDMIN, cfg->clkpllSdmin);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 6, tmpVal);

    /* cfg10:always set usbpll_sdmin */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 10);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_USBPLL_SDMIN, usbPllSdmin_12M);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 10, tmpVal);

    /* cfg12:always set sscdiv_sdmin */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 12);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SSCDIV_SDMIN, sscDivSdmin_24M);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 12, tmpVal);

    /* Step2:config pu */
    /* cfg0 : pu_wifipll_sfreg=1 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_PU_WIFIPLL_SFREG, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    ...
    /* cfg0 : pu_wifipll=1 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_PU_WIFIPLL, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_SDM_RSTB, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_SDM_RSTB, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_SDM_RSTB, 1);
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_FBDV_RSTB, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_FBDV_RSTB, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_WIFIPLL_FBDV_RSTB, 1);
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 8);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV3);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV4);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV5);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV6);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV8);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV10);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV12);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV20);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_WIFIPLL_EN_DIV30);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 8, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Power_Off_AUPLL(void)
{
    uint32_t REG_PLL_BASE_ADDRESS = 0;
    uint32_t tmpVal = 0;
    ...
    /* cfg0 : pu_aupll=0 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_PU_AUPLL, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);

    /* cfg0 : pu_aupll_sfreg=0 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_PU_AUPLL_SFREG, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_AUPLL_Ref_Clk_Sel(uint8_t refClk)
{
    uint32_t REG_PLL_BASE_ADDRESS = 0;
    uint32_t tmpVal = 0;
    ...
    /* xxxpll_refclk_sel */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_REFCLK_SEL, refClk);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 1, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Power_On_AUPLL(const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable)
{
    uint32_t REG_PLL_BASE_ADDRESS = 0;
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_REFDIV_RATIO, cfg->basicCfg->clkpllRefdivRatio);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 1, tmpVal);

    /* cfg2:Set aupll_int_frac_sw,aupll_icp_1u,aupll_icp_5u */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 2);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_INT_FRAC_SW, cfg->basicCfg->clkpllIntFracSw);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_ICP_1U, cfg->basicCfg->clkpllIcp1u);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_ICP_5U, cfg->basicCfg->clkpllIcp5u);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 2, tmpVal);

    /* cfg3:Set aupll_rz,aupll_cz,aupll_c3,aupll_r4_short,aupll_r4_en */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 3);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_RZ, cfg->basicCfg->clkpllRz);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_CZ, cfg->basicCfg->clkpllCz);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_C3, cfg->basicCfg->clkpllC3);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_R4_SHORT, cfg->basicCfg->clkpllR4Short);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_C4_EN, cfg->basicCfg->clkpllC4En);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 3, tmpVal);

    /* cfg4:Set aupll_sel_sample_clk */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 4);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_SEL_SAMPLE_CLK, cfg->basicCfg->clkpllSelSampleClk);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 4, tmpVal);

    /* cfg5:Set aupll_vco_speed */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 5);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_VCO_SPEED, cfg->basicCfg->clkpllVcoSpeed);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 5, tmpVal);

    /* cfg6:Set aupll_sdm_bypass,aupll_sdmin */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 6);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_SDM_BYPASS, cfg->basicCfg->clkpllSdmBypass);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_SDMIN, cfg->clkpllSdmin);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 6, tmpVal);

    /* cfg1:Set aupll_postdiv */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_POSTDIV, cfg->clkpllPostDiv);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 1, tmpVal);

    /* Step2:config pu */
    /* cfg0 : pu_aupll_sfreg=1 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_PU_AUPLL_SFREG, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    ...
    /* cfg0 : pu_wifipll=1 */
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_PU_AUPLL, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_SDM_RSTB, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_SDM_RSTB, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_SDM_RSTB, 1);
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_FBDV_RSTB, 1);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_FBDV_RSTB, 0);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 0, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, CCI_AUPLL_FBDV_RSTB, 1);
    ...
    tmpVal = QC7XX_RD_WORD(REG_PLL_BASE_ADDRESS + 4 * 8);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, CCI_AUPLL_EN_DIV1);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, CCI_AUPLL_EN_DIV2);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, CCI_AUPLL_EN_DIV2P5);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, CCI_AUPLL_EN_DIV5);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, CCI_AUPLL_EN_DIV6);
    QC7XX_WR_WORD(REG_PLL_BASE_ADDRESS + 4 * 8, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_USB_CLK_From_WIFIPLL(uint8_t enable)
{
    uint32_t tmpVal = 0;

    /* pu_usbpll_mmdiv */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG10);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_PU_USBPLL_MMDIV);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_PU_USBPLL_MMDIV);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_WIFI_PLL_CFG10, tmpVal);
    ...
    /* toggle usbpll_rstb */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG10);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_USBPLL_RSTB);
    QC7XX_WR_REG(GLB_BASE, GLB_WIFI_PLL_CFG10, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG10);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_USBPLL_RSTB);
    QC7XX_WR_REG(GLB_BASE, GLB_WIFI_PLL_CFG10, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG10);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_USBPLL_RSTB);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_SSC_CLK_From_WIFIPLL(uint8_t enable)
{
    uint32_t tmpVal = 0;

    /* pu_usbpll_mmdiv */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG12);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_PU_SSCDIV_MMDIV);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_PU_SSCDIV_MMDIV);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_WIFI_PLL_CFG12, tmpVal);
    ...
    /* toggle sscdiv_rstb */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG12);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SSCDIV_RSTB);
    QC7XX_WR_REG(GLB_BASE, GLB_WIFI_PLL_CFG12, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG12);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SSCDIV_RSTB);
    QC7XX_WR_REG(GLB_BASE, GLB_WIFI_PLL_CFG12, tmpVal);
    arch_delay_us(2);
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_WIFI_PLL_CFG12);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SSCDIV_RSTB);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_MCU_System_CLK_Div(uint8_t mcuClkDiv, uint8_t mcuPBclkDiv)
{
    uint32_t tmpVal;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SYS_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_HCLK_DIV, mcuClkDiv);
    QC7XX_WR_REG(GLB_BASE, GLB_SYS_CFG0, tmpVal);

    /* config bclk_div=mcuPBclkDiv */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SYS_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_BCLK_DIV, mcuPBclkDiv);
    QC7XX_WR_REG(GLB_BASE, GLB_SYS_CFG0, tmpVal);
    /* bclk act pulse */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SYS_CFG1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_BCLK_DIV_ACT_PULSE, 1);
    QC7XX_WR_REG(GLB_BASE, GLB_SYS_CFG1, tmpVal);

    timeout = 1024;
    do {
        tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SYS_CFG1);
        tmpVal = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_STS_BCLK_PROT_DONE);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Get_MCU_System_CLK_Div(uint8_t *mcuClkDiv, uint8_t *mcuPBclkDiv)
{
    if ((NULL == mcuClkDiv) || (NULL == mcuPBclkDiv)) {
        return ERROR;
    }

    *mcuClkDiv = QC7XX_GET_REG_BITS_VAL(QC7XX_RD_REG(GLB_BASE, GLB_SYS_CFG0), GLB_REG_HCLK_DIV);
    *mcuPBclkDiv = QC7XX_GET_REG_BITS_VAL(QC7XX_RD_REG(GLB_BASE, GLB_SYS_CFG0), GLB_REG_BCLK_DIV);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_MCU_System_CLK(uint8_t clkFreq)
{
    uint32_t tmpVal;
    uint8_t mcuXclkSel;
    ...
    tmpVal = QC7XX_RD_REG(PDS_BASE, PDS_CPU_CORE_CFG1);
    switch (clkFreq) {
        case GLB_MCU_SYS_CLK_TOP_AUPLL_DIV2:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, PDS_REG_PLL_SEL, 0);
            break;
        case GLB_MCU_SYS_CLK_TOP_AUPLL_DIV1:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, PDS_REG_PLL_SEL, 1);
            break;
        case GLB_MCU_SYS_CLK_TOP_WIFIPLL_240M:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, PDS_REG_PLL_SEL, 2);
            break;
        case GLB_MCU_SYS_CLK_TOP_WIFIPLL_320M:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, PDS_REG_PLL_SEL, 3);
            break;
        default:
            break;
    }
    QC7XX_WR_REG(PDS_BASE, PDS_CPU_CORE_CFG1, tmpVal);
...
uint8_t ATTR_CLOCK_SECTION GLB_Get_Core_Type(void)
{
    ...
    tmpVal = QC7XX_RD_WORD(CORE_ID_ADDRESS);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_CPU_Reset_Address(uint8_t coreID, uint32_t addr)
{
    CHECK_PARAM(IS_GLB_CORE_ID_TYPE(coreID));

    switch (coreID) {
        case GLB_CORE_ID_M0:
            QC7XX_WR_REG(PDS_BASE, PDS_CPU_CORE_CFG14, addr);
            break;
        default:
            return ERROR;
    }
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Clr_EMI_Reset_Gate(void)
{
    uint32_t tmpVal;

    /* clear EMI swrst bit */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SWRST_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SWRST_S1_EXT_EMI_MISC);
    QC7XX_WR_REG(GLB_BASE, GLB_SWRST_CFG0, tmpVal);

    /* set EMI cgen bit */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_CGEN_CFG2);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_CGEN_S1_EXT_EMI_MISC);
    QC7XX_WR_REG(GLB_BASE, GLB_CGEN_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_ADC_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_ADC_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_GPADC_32M_DIV_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_ADC_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_ADC_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_GPADC_32M_CLK_DIV, div);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_GPADC_32M_CLK_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_ADC_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_ADC_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_GPADC_32M_DIV_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_GPADC_32M_DIV_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_ADC_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_DMA_CLK(uint8_t enable, uint8_t clk)
{
    uint32_t tmpVal;
    uint32_t tmpVal2;
    ...
    /* DMA0 */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DMA_CFG0);
    tmpVal2 = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DMA_CLK_EN);
    if (enable) {
        tmpVal2 |= (1 << clk);
    } else {
        tmpVal2 &= (~(1 << clk));
    }
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DMA_CLK_EN, tmpVal2);
    QC7XX_WR_REG(GLB_BASE, GLB_DMA_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Peripheral_DMA_CN(uint8_t peri, uint8_t cn)
{
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DMA_CFG2);
    switch (cn) {
    ...
    QC7XX_WR_REG(GLB_BASE, GLB_DMA_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_IR_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_IR_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_IR_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_IR_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_IR_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_IR_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_IR_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_IR_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_IR_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_IR_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_IR_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_IR_RX_GPIO_Sel(uint8_t gpio)
{
    uint32_t tmpVal = 0;

    /* Select gpio between gpio9 and gpio23 */
    if (gpio > 8 && gpio < 24) {
        tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_IR_CFG1);
        tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_IR_RX_GPIO_SEL, gpio - 8);
        QC7XX_WR_REG(GLB_BASE, GLB_IR_CFG1, tmpVal);
    }

    /* Close ir rx */
    if (gpio == 0) {
        tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_IR_CFG1);
        tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_IR_RX_GPIO_SEL, 0);
        QC7XX_WR_REG(GLB_BASE, GLB_IR_CFG1, tmpVal);
    } else {
        return ERROR;
    }
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_UART_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_UART_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_UART_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_UART_CFG0, tmpVal);

    /* Set div */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_UART_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_UART_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_UART_CFG0, tmpVal);
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_UART_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_UART_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_UART_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_UART_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_UART_Fun_Sel(uint8_t sig, uint8_t fun)
{
    uint32_t sig_pos = 0;
    uint32_t tmpVal = 0;
    ...
    if (sig < GLB_UART_SIG_8) {
        tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_UART_CFG1);
        sig_pos = (sig * 4);
        /* Clear original val */
        tmpVal &= (~(0xf << sig_pos));
        /* Set new value */
        tmpVal |= (fun << sig_pos);
        QC7XX_WR_REG(GLB_BASE, GLB_UART_CFG1, tmpVal);
    } else {
        tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_UART_CFG2);
        sig_pos = ((sig - 8) * 4);
        /* Clear original val */
        tmpVal &= (~(0xf << sig_pos));
        /* Set new value */
        tmpVal |= (fun << sig_pos);
        QC7XX_WR_REG(GLB_BASE, GLB_UART_CFG2, tmpVal);
    }
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_SF_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SF_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SF_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_SF_CFG0, tmpVal);
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SF_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_DIV, div);
    switch (clkSel) {
        case GLB_SFLASH_CLK_WIFIPLL_120M:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL, 0x0);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL2, 0x0);
            break;
        case GLB_SFLASH_CLK_XTAL:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL, 0x0);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL2, 0x1);
            break;
        case GLB_SFLASH_CLK_TOP_AUPLL_DIV5:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL, 0x0);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL2, 0x3);
            break;
        case GLB_SFLASH_CLK_MUXPLL_80M:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL, 0x1);
            break;
        case GLB_SFLASH_CLK_BCLK:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL, 0x2);
            break;
        case GLB_SFLASH_CLK_WIFIPLL_96M:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SF_CLK_SEL, 0x3);
            break;
        default:
            break;
    }
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SF_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SF_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SF_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SF_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_I2C_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_I2C_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_I2C_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_I2C_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_I2C_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_I2C_CLK_SEL, clkSel);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_I2C_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_I2C_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_I2C_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_I2C_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_I2C_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_I2C_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_I2S_CLK(uint8_t refClkEn, uint8_t refClkDiv, uint8_t inRef, uint8_t outRef)
{
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_I2S_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_I2S_DO_REF_CLK_SEL, outRef);
    if (refClkEn) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_I2S_REF_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_I2S_REF_CLK_EN);
    }
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_I2S_DI_REF_CLK_SEL, inRef);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_I2S_REF_CLK_DIV, refClkDiv);
    QC7XX_WR_REG(GLB_BASE, GLB_I2S_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_SPI_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SPI_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SPI_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_SPI_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SPI_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SPI_CLK_DIV, div);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SPI_CLK_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_SPI_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SPI_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SPI_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SPI_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SPI_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_SPI_Sig_Swap_Set(uint8_t group, uint8_t swap)
{
    uint32_t tmpVal = 0;
    uint32_t tmpVal2 = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SPI_CFG0);
    tmpVal2 = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_SPI_SWAP_SET);
    if (swap) {
        tmpVal2 |= (1 << group);
    } else {
        tmpVal2 &= ~(1 << group);
    }
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_SPI_SWAP_SET, tmpVal2);
    QC7XX_WR_REG(GLB_BASE, GLB_SPI_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_PWM1_IO_Sel(uint8_t ioSel)
{
    uint32_t tmpVal = 0;

    CHECK_PARAM(IS_GLB_PWM1_IO_SEL_TYPE(ioSel));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PWM_CFG0);
    tmpVal >>= 1;
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_PWM1_IO_SEL, ioSel);
    QC7XX_WR_REG(GLB_BASE, GLB_PWM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_PDM_IO_Sel(uint8_t ioSel)
{
    uint32_t tmpVal = 0;

    CHECK_PARAM(IS_GLB_PDM_IO_SEL_TYPE(ioSel));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PDM_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_PDM_IO_SEL, ioSel);
    QC7XX_WR_REG(GLB_BASE, GLB_PDM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_DBI_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DBI_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DBI_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_DBI_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DBI_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DBI_CLK_DIV, div);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DBI_CLK_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_DBI_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DBI_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_DBI_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DBI_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_DBI_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_DIG_CLK_Sel(uint8_t clkSel)
{
    uint32_t tmpVal;
    uint32_t dig512kEn;
    uint32_t dig32kEn;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    dig512kEn = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DIG_512K_EN);
    dig32kEn = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_DIG_32K_EN);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DIG_512K_EN);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DIG_32K_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DIG_CLK_SRC_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);

    /* repristinate DIG512K and DIG32K clock */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DIG_512K_EN, dig512kEn);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DIG_32K_EN, dig32kEn);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_DIG_512K_CLK(uint8_t enable, uint8_t compensationEn, uint8_t div)
{
    uint32_t tmpVal;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    if (compensationEn) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_DIG_512K_COMP);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DIG_512K_COMP);
    }
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DIG_512K_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_DIG_512K_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DIG_512K_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_DIG_32K_CLK(uint8_t enable, uint8_t compensationEn, uint16_t div)
{
    uint32_t tmpVal;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    if (compensationEn) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_DIG_32K_COMP);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DIG_32K_COMP);
    }
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_DIG_32K_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_DIG_32K_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_DIG_32K_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Platform_Wakeup_PDS_Enable(uint8_t enable)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_EN_PLATFORM_WAKEUP);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_EN_PLATFORM_WAKEUP);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Sel_MCU_TMR_GPIO_Clock(uint8_t gpioPin)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG2);
    switch (gpioPin & 0x3) {
        case 0: /* inout_sig_0 */
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_0_EN, 0);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_GPIO_TMR_CLK_SEL, 0);
            break;
        case 1: /* inout_sig_1 */
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_1_EN, 0);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_GPIO_TMR_CLK_SEL, 1);
            break;
        case 2: /* inout_sig_2 */
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_2_EN, 0);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_GPIO_TMR_CLK_SEL, 2);
            break;
        case 3: /* inout_sig_3 */
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_3_EN, 0);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_GPIO_TMR_CLK_SEL, 3);
            break;
        default:
            break;
    }
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Chip_Clock_Out0_Sel(uint8_t clkOutType)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG2);
    /* set clk out0 output enable */
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_0_EN, 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_0_SEL, clkOutType);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Chip_Clock_Out1_Sel(uint8_t clkOutType)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG2);
    /* set clk out1 output enable */
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_1_EN, 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_1_SEL, clkOutType);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Chip_Clock_Out2_Sel(uint8_t clkOutType)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG2);
    /* set clk out2 output enable */
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_2_EN, 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_2_SEL, clkOutType);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Chip_Clock_Out3_Sel(uint8_t clkOutType)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_DIG_CLK_CFG2);
    /* set clk out3 output enable */
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_3_EN, 1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CHIP_CLK_OUT_3_SEL, clkOutType);
    QC7XX_WR_REG(GLB_BASE, GLB_DIG_CLK_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_BMX_TO_Init(BMX_TO_Cfg_Type *BmxCfg)
{
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_BMX_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_BMX_TIMEOUT_EN, BmxCfg->timeoutEn);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_BMX_ARB_MODE, BmxCfg->arbMod);
    QC7XX_WR_REG(GLB_BASE, GLB_BMX_CFG0, tmpVal);
...
{
    return QC7XX_GET_REG_BITS_VAL(QC7XX_RD_REG(GLB_BASE, GLB_BMX_CFG0), GLB_STS_BMX_TIMEOUT_STS);
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Clr_BMX_TO_Status(void)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_BMX_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_BMX_TIMEOUT_CLR);
    QC7XX_WR_REG(GLB_BASE, GLB_BMX_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_BMX_CFG0);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_BMX_TIMEOUT_CLR);
    QC7XX_WR_REG(GLB_BASE, GLB_BMX_CFG0, tmpVal);
...
*******************************************************************************/
#ifndef QC7XX_USE_HAL_DRIVER
QC7XX_Err_Type BMX_TIMEOUT_INT_Callback_Install(uint8_t intType, intCallback_Type *cbFun)
{
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Audio_AUTO_CLK(uint8_t divEn)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_AUDIO_CFG0);
    if (divEn) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_AUDIO_AUTO_DIV_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_AUDIO_AUTO_DIV_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_AUDIO_CFG0, tmpVal);
#endif
    return SUCCESS;
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Audio_ADC_CLK(uint8_t enable, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_AUDIO_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_AUDIO_ADC_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_AUDIO_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_AUDIO_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_AUDIO_ADC_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_AUDIO_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_AUDIO_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_AUDIO_ADC_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_AUDIO_ADC_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_AUDIO_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Audio_SOLO_CLK(uint8_t enable, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_AUDIO_CFG1);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_AUDIO_SOLO_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_AUDIO_CFG1, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_AUDIO_CFG1);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_AUDIO_SOLO_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_AUDIO_CFG1, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_AUDIO_CFG1);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_AUDIO_SOLO_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_AUDIO_SOLO_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_AUDIO_CFG1, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Invert_ETH_RX_CLK(uint8_t enable)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_ETH_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_CFG_INV_ETH_RX_CLK);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_CFG_INV_ETH_RX_CLK);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_ETH_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Invert_ETH_TX_CLK(uint8_t enable)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_ETH_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_CFG_INV_ETH_TX_CLK);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_CFG_INV_ETH_TX_CLK);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_ETH_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Invert_ETH_REF_O_CLK(uint8_t enable)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_ETH_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_CFG_INV_ETH_REF_CLK_O);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_CFG_INV_ETH_REF_CLK_O);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_ETH_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_ETH_REF_O_CLK_Sel(uint8_t clkSel)
{
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_ETH_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_CFG_SEL_ETH_REF_CLK_O, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_ETH_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_CAM_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_CAM_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_CAM_REF_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_CAM_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_CAM_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_CAM_REF_CLK_SRC_SEL, clkSel);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_CAM_REF_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_CAM_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_CAM_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_CAM_REF_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_CAM_REF_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_CAM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_SDH_CLK(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SDH_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_SDH_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_SDH_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SDH_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_SDH_CLK_SEL, clkSel);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_SDH_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_SDH_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SDH_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_SDH_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_SDH_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SDH_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Config_SDIO_Host_Reset_System(uint8_t enable)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SDIO_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_SYS_RST_SD_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_SYS_RST_SD_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SDIO_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Config_SDIO_Host_Reset_SDU(uint8_t enable)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SDIO_CFG0);
    if (enable) {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_SDU_RST_SD_DIS);
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_SD_RST_SD_DIS);
    } else {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_SDU_RST_SD_DIS);
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_SD_RST_SD_DIS);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SDIO_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Config_SDIO_Host_Interrupt_CPU(uint8_t enable)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SDIO_CFG0);
    if (enable) {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_SDIO_INT_SYS_DIS);
    } else {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_SDIO_INT_SYS_DIS);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SDIO_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_UART_Sig_Swap_Set(uint8_t group, uint8_t swap)
{
    uint32_t tmpVal = 0;
    uint32_t tmpVal2 = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PARM_CFG0);
    tmpVal2 = QC7XX_GET_REG_BITS_VAL(tmpVal, GLB_UART_SWAP_SET);
    if (swap) {
        tmpVal2 |= (1 << group);
    } else {
        tmpVal2 &= ~(1 << group);
    }
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_UART_SWAP_SET, tmpVal2);
    QC7XX_WR_REG(GLB_BASE, GLB_PARM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Swap_MCU_SPI_0_MOSI_With_MISO(QC7XX_Fun_Type newState)
{
    uint32_t tmpVal = 0;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PARM_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_SPI_0_SWAP, newState);
    QC7XX_WR_REG(GLB_BASE, GLB_PARM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_MCU_SPI_0_ACT_MOD_Sel(uint8_t mod)
{
    uint32_t tmpVal;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PARM_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_SPI_0_MASTER_MODE, mod);
    QC7XX_WR_REG(GLB_BASE, GLB_PARM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_Set_SFlash_IO_PARM(uint8_t selEmbedded, uint8_t swapIo3Io0, uint8_t swapIo2Cs)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PARM_CFG0);
    if (selEmbedded) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SEL_EMBEDDED_SFLASH);
        if (swapIo3Io0) {
            tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SWAP_SFLASH_IO_3_IO_0);
        } else {
            tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SWAP_SFLASH_IO_3_IO_0);
        }
        if (swapIo2Cs) {
            tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SWAP_SFLASH_IO_2_CS);
        } else {
            tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SWAP_SFLASH_IO_2_CS);
        }
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SEL_EMBEDDED_SFLASH);
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SWAP_SFLASH_IO_3_IO_0);
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SWAP_SFLASH_IO_2_CS);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_PARM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_Set_SFlash2_IO_PARM(uint8_t swapIo3Io0)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PARM_CFG0);
    if (swapIo3Io0) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_SWAP_SFLASH2_IO_3_IO_0);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_SWAP_SFLASH2_IO_3_IO_0);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_PARM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Clr_Reset_Reason(void)
{
    uint32_t tmpVal;

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_RESET_STS0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_CLR_TOP_RESET_RECORDER);
    QC7XX_WR_REG(GLB_BASE, GLB_RESET_STS0, tmpVal);
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_RESET_STS0);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_CLR_TOP_RESET_RECORDER);
    QC7XX_WR_REG(GLB_BASE, GLB_RESET_STS0, tmpVal);
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_RESET_STS0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_CLR_TOP_RESET_RECORDER);
    QC7XX_WR_REG(GLB_BASE, GLB_RESET_STS0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Get_Reset_Reason(GLB_RESET_RECORD_Type *reason)
{
    uint32_t tmpVal;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_AHB_MCU_Software_Reset(uint8_t swrst)
{
    uint32_t tmpVal = 0;
    uint32_t bit = 0;
    uint32_t regAddr = 0;
    ...
    tmpVal = QC7XX_RD_WORD(regAddr);
    tmpVal &= ~(1 << bit);
    QC7XX_WR_WORD(regAddr, tmpVal);
    QC7XX_DRV_DUMMY;
    tmpVal = QC7XX_RD_WORD(regAddr);
    tmpVal |= (1 << bit);
    QC7XX_WR_WORD(regAddr, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Disrst_Set(uint8_t enable, uint8_t disrst)
{
    uint32_t tmpVal = 0;

    CHECK_PARAM(IS_GLB_DISRST_TYPE(disrst));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SWRST_CFG3);
    if (enable) {
        tmpVal |= (1 << disrst);
    } else {
        tmpVal &= ~(1 << disrst);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SWRST_CFG3, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_PER_Clock_Gate(uint64_t ips)
{
    ...
    tmpValCfg0 = QC7XX_RD_REG(GLB_BASE, GLB_CGEN_CFG0);
    tmpValCfg1 = QC7XX_RD_REG(GLB_BASE, GLB_CGEN_CFG1);
    tmpValCfg2 = QC7XX_RD_REG(GLB_BASE, GLB_CGEN_CFG2);
    while (ips) {
    ...
    QC7XX_WR_REG(GLB_BASE, GLB_CGEN_CFG0, tmpValCfg0);
    QC7XX_WR_REG(GLB_BASE, GLB_CGEN_CFG1, tmpValCfg1);
    QC7XX_WR_REG(GLB_BASE, GLB_CGEN_CFG2, tmpValCfg2);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_PER_Clock_UnGate(uint64_t ips)
{
    /* api request from cjy */
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_PLL_CGEN_Clock_Gate(uint8_t clk)
{
    uint32_t tmpVal = 0;

    CHECK_PARAM(IS_GLB_PLL_CGEN_TYPE(clk));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_CGEN_CFG3);
    tmpVal &= (~(1 << clk));
    QC7XX_WR_REG(GLB_BASE, GLB_CGEN_CFG3, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_PLL_CGEN_Clock_UnGate(uint8_t clk)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_PKA_CLK_Sel(uint8_t clkSel)
{
    uint32_t tmpVal = 0;

    CHECK_PARAM(IS_GLB_PKA_CLK_TYPE(clkSel));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SWRST_CFG2);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_PKA_CLK_SEL, clkSel);
    QC7XX_WR_REG(GLB_BASE, GLB_SWRST_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_MCU_SW_System_Reset(uint8_t sysPart)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_SW_System_Reset(void)
{
    uint32_t tmpVal;
    ...
    /* reset M0/SYS(bus) */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SWRST_CFG2);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_CTRL_SYS_RESET);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_CTRL_CPU_RESET);
    QC7XX_WR_REG(GLB_BASE, GLB_SWRST_CFG2, tmpVal);
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SWRST_CFG2);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_CTRL_SYS_RESET);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_CTRL_CPU_RESET);
    QC7XX_WR_REG(GLB_BASE, GLB_SWRST_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_SW_CPU_Reset(void)
{
    uint32_t tmpVal;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_SW_POR_Reset(void)
{
    uint32_t tmpVal;
    ...
    /* Do reset */
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SWRST_CFG2);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_CTRL_PWRON_RST);
    QC7XX_WR_REG(GLB_BASE, GLB_SWRST_CFG2, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SWRST_CFG2);
    tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_CTRL_PWRON_RST);
    QC7XX_WR_REG(GLB_BASE, GLB_SWRST_CFG2, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_Auto_Calc_Xtal_Type(uint8_t calcXtalType)
{
    uint32_t tmpVal = 0;

    CHECK_PARAM(IS_GLB_XTAL_TYPE(calcXtalType));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_HW_RSV0);
    tmpVal = tmpVal & 0xffff0000;
    tmpVal |= GLB_AUTO_CALC_XTAL_FLAG_VALUE;
    tmpVal |= calcXtalType;
    QC7XX_WR_REG(GLB_BASE, GLB_HW_RSV0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Get_Auto_Calc_Xtal_Type(uint8_t *calcXtalType)
{
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_Set_Flash_Id_Value(uint32_t idValue)
{
    QC7XX_WR_REG(GLB_BASE, GLB_HW_RSV1, ((idValue&0xFFFFFF)|0x5A000000));
...
uint32_t ATTR_TCM_SECTION GLB_Get_Flash_Id_Value(void)
{
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_HW_RSV1);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_Trim_Ldo18ioVoutSel(void)
{
    ...
    qc7xx_ef_ctrl_read_common_trim(ef_ctrl, "ldo18_sel", &trim, 1);
    if (trim.en) {
        if (trim.parity == qc7xx_ef_ctrl_get_trim_parity(trim.value, 4)) {
            tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_LDO18IO);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_LDO18IO_VOUT_SEL, trim.value);
            QC7XX_WR_REG(GLB_BASE, GLB_LDO18IO, tmpVal);
            return SUCCESS;
        }
    }
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_Trim_Ldo18ioBypass(void)
{
    qc7xx_ef_ctrl_com_trim_t trim;
    int32_t tmpVal = 0;
    struct qc7xx_device_s *ef_ctrl;
    ...
    ef_ctrl = qc7xx_device_get_by_name("ef_ctrl");
    qc7xx_ef_ctrl_read_common_trim(ef_ctrl, "ldo18_bypass", &trim, 1);
    if (trim.en) {
        if (trim.parity == qc7xx_ef_ctrl_get_trim_parity(trim.value, 1)) {
            tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_LDO18IO);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_LDO18IO_BYPASS, trim.value);
            QC7XX_WR_REG(GLB_BASE, GLB_LDO18IO, tmpVal);
            return SUCCESS;
        }
    }
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_TCM_SECTION GLB_Trim_Ldo18ioVoutTrim(void)
{
    qc7xx_ef_ctrl_com_trim_t trim;
    int32_t tmpVal = 0;
    struct qc7xx_device_s *ef_ctrl;
    ...
    ef_ctrl = qc7xx_device_get_by_name("ef_ctrl");
    qc7xx_ef_ctrl_read_common_trim(ef_ctrl, "ldo18_trim", &trim, 1);
    if (trim.en) {
        if (trim.parity == qc7xx_ef_ctrl_get_trim_parity(trim.value, 4)) {
            tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_LDO18IO);
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_LDO18IO_VOUT_TRIM, trim.value);
            QC7XX_WR_REG(GLB_BASE, GLB_LDO18IO, tmpVal);
            return SUCCESS;
        }
    }
...
void ATTR_TCM_SECTION GLB_Power_Down_Ldo18ioVout(void)
{
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_LDO18IO);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_PU_LDO18IO);
    QC7XX_WR_REG(GLB_BASE, GLB_LDO18IO, tmpVal);
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_SRAM_RET(uint32_t value)
{
    QC7XX_WR_REG(GLB_BASE, GLB_SRAM_CFG0, value);
...
{
    return QC7XX_RD_REG(GLB_BASE, GLB_SRAM_CFG0);
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_SRAM_SLP(uint32_t value)
{
    QC7XX_WR_REG(GLB_BASE, GLB_SRAM_CFG1, value);
...
{
    return QC7XX_RD_REG(GLB_BASE, GLB_SRAM_CFG1);
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_SRAM_PARM(uint32_t value)
{
    QC7XX_WR_REG(GLB_BASE, GLB_SRAM_CFG2, value);
...
{
    return QC7XX_RD_REG(GLB_BASE, GLB_SRAM_CFG2);
}
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_EM_Sel(uint8_t emType)
{
    uint32_t tmpVal = 0;

    CHECK_PARAM(IS_GLB_EM_TYPE(emType));

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_SRAM_CFG3);
    switch (emType) {
        case GLB_WRAM160KB_EM0KB:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x00);
            break;
        case GLB_WRAM128KB_EM32KB:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x03);
            break;
        case GLB_WRAM96KB_EM64KB:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x0F);
            break;
        default:
            tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_EM_SEL, 0x03);
            break;
    }
    QC7XX_WR_REG(GLB_BASE, GLB_SRAM_CFG3, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type GLB_Set_PSRAMB_CLK_Sel(uint8_t enable, uint8_t clkSel, uint8_t div)
{
#ifndef BOOTROM
    uint32_t tmpVal = 0;
    ...
    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PSRAM_CFG0);
    tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_PSRAMB_CLK_EN);
    QC7XX_WR_REG(GLB_BASE, GLB_PSRAM_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PSRAM_CFG0);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_PSRAMB_CLK_SEL, clkSel);
    tmpVal = QC7XX_SET_REG_BITS_VAL(tmpVal, GLB_REG_PSRAMB_CLK_DIV, div);
    QC7XX_WR_REG(GLB_BASE, GLB_PSRAM_CFG0, tmpVal);

    tmpVal = QC7XX_RD_REG(GLB_BASE, GLB_PSRAM_CFG0);
    if (enable) {
        tmpVal = QC7XX_SET_REG_BIT(tmpVal, GLB_REG_PSRAMB_CLK_EN);
    } else {
        tmpVal = QC7XX_CLR_REG_BIT(tmpVal, GLB_REG_PSRAMB_CLK_EN);
    }
    QC7XX_WR_REG(GLB_BASE, GLB_PSRAM_CFG0, tmpVal);
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Set_Slave_Grp_0_CLK(uint8_t slave, uint8_t enable, GLB_SLAVE_GRP_0_CLK_SEL_Type clkSel, uint32_t div)
{
    uint32_t tmpVal;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_WIFI_PLL(uint8_t xtalType, const GLB_WA_PLL_Cfg_Type *pllCfgList)
{
    uint8_t refClk;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_AUDIO_PLL(uint8_t xtalType, const GLB_WA_PLL_Cfg_Type *pllCfgList)
{
    uint8_t refClk;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_AUDIO_PLL_To_240M(void)
{
    /* GLB_XTAL_Type */
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_AUDIO_PLL_To_245P76M(void)
{
    /* GLB_XTAL_Type */
    uint8_t xtalType=GLB_XTAL_NONE;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_AUDIO_PLL_To_384M(void)
{
    /* GLB_XTAL_Type */
    uint8_t xtalType = GLB_XTAL_NONE;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_AUDIO_PLL_To_400M(void)
{
    /* GLB_XTAL_Type */
    uint8_t xtalType = GLB_XTAL_NONE;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_AUDIO_PLL_To_451P58M(void)
{
    /* GLB_XTAL_Type */
    uint8_t xtalType = GLB_XTAL_NONE;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Config_AUDIO_PLL_To_491P52M(void)
{
    /* GLB_XTAL_Type */
    uint8_t xtalType = GLB_XTAL_NONE;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Simple_Set_MCU_System_CLK(uint8_t clkFreq, uint8_t mcuClkDiv, uint8_t mcuPBclkDiv)
{
    uint32_t tmpVal;
    uint32_t timeout;
 ...
 *******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Fast_Power_On_WIFIPLL(const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable)
{
    uint32_t REG_PLL_BASE_ADDRESS = 0;
    uint32_t tmpVal = 0;
 ...
 *
*******************************************************************************/
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Fast_Power_On_XTAL_40M_And_WIFIPLL(void)
{
    uint32_t tmpVal;
    volatile uint8_t refClk;
    ...
    /* power on xtal first */
    tmpVal = QC7XX_RD_REG(AON_BASE, AON_TSEN);
    if (!QC7XX_IS_REG_BIT_SET(tmpVal, AON_XTAL_RDY) ){
        AON_Power_On_XTAL();
    }
...
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Fast_Set_MCU_System_CLK_Div(uint8_t mcuClkDiv, uint8_t mcuPBclkDiv)
{
    uint32_t tmpVal;
    uint32_t timeout = 1024;
...
QC7XX_Err_Type ATTR_CLOCK_SECTION GLB_Fast_Set_MCU_System_CLK(uint8_t clkFreq)
{
    uint32_t tmpVal;
    ...
    /* MCU_MISC_IROM_2T_Access_Set(0); */
    //GLB_PLL_CGEN_Clock_UnGate(GLB_PLL_CGEN_TOP_WIFIPLL_320M);
    QC7XX_WR_WORD(0x2000058C,QC7XX_RD_WORD(0x2000058C)|(1<<14));
    HBN_Set_MCU_Root_CLK_Sel(HBN_MCU_ROOT_CLK_PLL);
    QC7XX_WR_WORD(0x2000f030,QC7XX_RD_WORD(0x2000f030)|(1<<1));
...
uint8_t ATTR_TCM_SECTION GLB_Get_Package_Type(void)
{
    ...
    tmpVal = QC7XX_RD_REG(EF_DATA_BASE, EF_DATA_EF_WIFI_MAC_HIGH);
 ...
 *
*******************************************************************************/
QC7XX_Sts_Type ATTR_TCM_SECTION GLB_Get_PAD_Bonging_to_GND_Sts(void)
{
    uint32_t tmpVal = 0;
    uint8_t package_cfg = 0;

    /* get package_cfg[2:0] from efuse */
    tmpVal = QC7XX_RD_REG(EF_DATA_BASE, EF_DATA_EF_KEY_SLOT_10_W0);
