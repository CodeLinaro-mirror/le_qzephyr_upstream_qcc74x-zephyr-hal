...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type EF_Ctrl_Crc_Result(void){
    return RomDriver_EF_Ctrl_Crc_Result();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type EF_Ctrl_Get_Customer_PIDVID(uint16_t pid[1], uint16_t vid[1]){
    return RomDriver_EF_Ctrl_Get_Customer_PIDVID(pid,vid);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type EF_Ctrl_Read_Chip_ID(uint8_t chipID[8]){
    return RomDriver_EF_Ctrl_Read_Chip_ID(chipID);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type EF_Ctrl_Read_MAC_Address(uint8_t mac[6]){
    return RomDriver_EF_Ctrl_Read_MAC_Address(mac);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type EF_Ctrl_Read_MAC_Address_Raw(uint8_t mac[7]){
    return RomDriver_EF_Ctrl_Read_MAC_Address_Raw(mac);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Sts_Type EF_Ctrl_AutoLoad_Done(void){
    return RomDriver_EF_Ctrl_AutoLoad_Done();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Sts_Type EF_Ctrl_Busy(void){
    return RomDriver_EF_Ctrl_Busy();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Sts_Type EF_Ctrl_Crc_Is_Busy(void){
...
/* Efuse_ADC_Gain_Coeff_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* Efuse_Ana_Ldo11socVoutTrim_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* Efuse_Ana_Ldo18ioBypass_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* Efuse_Ana_Ldo18ioVoutSel_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* Efuse_Ana_Ldo18ioVoutTrim_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* Efuse_Ana_Ldo33VoutTrim_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* Efuse_TSEN_Refcode_Corner_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void EF_Ctrl_Read_TSEN_Trim(Efuse_TSEN_Refcode_Corner_Type *trim){
    return RomDriver_EF_Ctrl_Read_TSEN_Trim(trim);
}

/* Efuse_Ana_Usb20RcalCode_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* EF_Ctrl_Sign_Type and EF_Ctrl_SF_AES_Type are all defined as uint8_t */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_AUPLL_Ref_Clk_Sel(uint8_t refClk){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Clr_EMI_Reset_Gate(void){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Get_MCU_System_CLK_Div(uint8_t *mcuClkDiv, uint8_t *mcuPBclkDiv){
    return RomDriver_GLB_Get_MCU_System_CLK_Div(mcuClkDiv,mcuPBclkDiv);
}

/* GLB_RESET_RECORD_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_MCU_SW_System_Reset(uint8_t sysPart){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_PLL_CGEN_Clock_Gate(uint8_t clk){
    return RomDriver_GLB_PLL_CGEN_Clock_Gate(clk);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_PLL_CGEN_Clock_UnGate(uint8_t clk){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Power_Off_AUPLL(void){
    return RomDriver_GLB_Power_Off_AUPLL();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Power_Off_WIFIPLL(void){
    return RomDriver_GLB_Power_Off_WIFIPLL();
}

/* GLB_WA_PLL_Cfg_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Power_On_AUPLL(const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable){
    return RomDriver_GLB_Power_On_AUPLL(cfg,waitStable);
}

/* GLB_WA_PLL_Cfg_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Power_On_WIFIPLL(const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable){
    return RomDriver_GLB_Power_On_WIFIPLL(cfg,waitStable);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Power_On_XTAL_And_PLL_CLK(uint8_t xtalType, uint8_t pllType){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_SW_CPU_Reset(void){
    return RomDriver_GLB_SW_CPU_Reset();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_SW_POR_Reset(void){
    return RomDriver_GLB_SW_POR_Reset();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_SW_System_Reset(void){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_CPU_Reset_Address(uint8_t coreID, uint32_t addr){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_ISP_Muxpll_80M_Sel(uint8_t clkSel){
    return RomDriver_GLB_Set_ISP_Muxpll_80M_Sel(clkSel);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_MCU_Muxpll_160M_Sel(uint8_t clkSel){
    return RomDriver_GLB_Set_MCU_Muxpll_160M_Sel(clkSel);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_MCU_Muxpll_80M_Sel(uint8_t clkSel){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_MCU_System_CLK(uint8_t clkFreq){
    return RomDriver_GLB_Set_MCU_System_CLK(clkFreq);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_MCU_System_CLK_Div(uint8_t mcuClkDiv, uint8_t mcuPBclkDiv){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_PKA_CLK_Sel(uint8_t clkSel){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_SF_CLK(uint8_t enable, uint8_t clkSel, uint8_t div){
    return RomDriver_GLB_Set_SF_CLK(enable,clkSel,div);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_SFlash2_IO_PARM(uint8_t swapIo3Io0){
    return RomDriver_GLB_Set_SFlash2_IO_PARM(swapIo3Io0);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_SFlash_IO_PARM(uint8_t selEmbedded, uint8_t swapIo3Io0, uint8_t swapIo2Cs){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_SSC_CLK_From_WIFIPLL(uint8_t enable){
    return RomDriver_GLB_Set_SSC_CLK_From_WIFIPLL(enable);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_Slave_Grp_0_CLK(uint8_t slave, uint8_t enable, GLB_SLAVE_GRP_0_CLK_SEL_Type clkSel, uint32_t div){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Set_USB_CLK_From_WIFIPLL(uint8_t enable){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Trim_Ldo18ioBypass(void){
    return RomDriver_GLB_Trim_Ldo18ioBypass();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Trim_Ldo18ioVoutSel(void){
    return RomDriver_GLB_Trim_Ldo18ioVoutSel();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Trim_Ldo18ioVoutTrim(void){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_WIFIPLL_Ref_Clk_Sel(uint8_t refClk){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_Embedded_Flash_Pad_Enable(uint8_t swapIo2Cs){
...
/* GLB_GPIO_FIFO_CFG_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* GLB_GPIO_Cfg_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_GPIO_Init(GLB_GPIO_Cfg_Type *cfg){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_GPIO_Input_Disable(uint8_t gpioPin){
    return RomDriver_GLB_GPIO_Input_Disable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_GPIO_Input_Enable(uint8_t gpioPin){
...
/* GLB_GPIO_INT_Cfg_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_GPIO_Output_Disable(uint8_t gpioPin){
    return RomDriver_GLB_GPIO_Output_Disable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_GPIO_Output_Enable(uint8_t gpioPin){
    if (RESET == GLB_GPIO_Pad_LeadOut_Sts(gpioPin)) {
        return ERROR;
    }
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type GLB_GPIO_Set_HZ(uint8_t gpioPin){
    if (RESET == GLB_GPIO_Pad_LeadOut_Sts(gpioPin)) {
        return ERROR;
    }
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_32K_Sel(uint8_t clkType){
    return RomDriver_HBN_32K_Sel(clkType);
}
#endif

/* HBN_AON_PAD_CFG_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Aon_Pad_Cfg(uint8_t aonPadHwCtrlEn, uint8_t aonGpio, HBN_AON_PAD_CFG_Type *aonPadCfg){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Aon_Pad_Cfg_Set(uint8_t aonPadHwCtrlEn, uint8_t aonGpio){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Aon_Pad_Ctrl(uint32_t aonPadCtl1, uint32_t aonPadCtl2){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Clear_Gpio_Keep(uint8_t gpioKeep){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Clear_PDS_Gpio_Keep(uint8_t gpioKeep){
    return RomDriver_HBN_Clear_PDS_Gpio_Keep(gpioKeep);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Clear_RTC_Counter(void){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Enable_RTC_Counter(void){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_GPIO_INT_Enable(uint8_t gpioIntTrigType){
    return RomDriver_HBN_GPIO_INT_Enable(gpioIntTrigType);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Get_Flash_Power_Delay(uint8_t *flashPwrDly){
    return RomDriver_HBN_Get_Flash_Power_Delay(flashPwrDly);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Get_Gpio_Keep(uint8_t *gpioKeep){
    return RomDriver_HBN_Get_Gpio_Keep(gpioKeep);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Get_Ldo18io_Power_Delay_Config(uint16_t *pwrOffDly, uint16_t *pwrOnDly){
    return RomDriver_HBN_Get_Ldo18io_Power_Delay_Config(pwrOffDly,pwrOnDly);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Get_PDS_Gpio_Keep(uint8_t *gpioKeep){
    return RomDriver_HBN_Get_PDS_Gpio_Keep(gpioKeep);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Get_RTC_Timer_Val(uint32_t *valLow, uint32_t *valHigh){
    return RomDriver_HBN_Get_RTC_Timer_Val(valLow,valHigh);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Get_Xtal_Type(uint8_t *xtalType){
    return RomDriver_HBN_Get_Xtal_Type(xtalType);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Hw_Pu_Pd_Cfg(uint8_t enable){
    return RomDriver_HBN_Hw_Pu_Pd_Cfg(enable);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Keep_On_RC32K(void){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Pin_WakeUp_Mask(uint8_t maskVal){
    return RomDriver_HBN_Pin_WakeUp_Mask(maskVal);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Power_Off_RC32K(void){
    return RomDriver_HBN_Power_Off_RC32K();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Power_Off_Xtal_32K(void){
    return RomDriver_HBN_Power_Off_Xtal_32K();
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Power_On_Xtal_32K(void){
    return RomDriver_HBN_Power_On_Xtal_32K();
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Reset(void){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Core_Reboot_Config(uint8_t core, uint8_t hcfg){
    return RomDriver_HBN_Set_Core_Reboot_Config(core,hcfg);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Flash_Power_Delay(uint8_t flashPwrDly){
    return RomDriver_HBN_Set_Flash_Power_Delay(flashPwrDly);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_GPADC_CLK_Sel(uint8_t clkSel){
    return RomDriver_HBN_Set_GPADC_CLK_Sel(clkSel);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Gpio_Keep(uint8_t gpioKeep){
    return RomDriver_HBN_Set_Gpio_Keep(gpioKeep);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_HRAM_Ret(void){
    return RomDriver_HBN_Set_HRAM_Ret();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_HRAM_slp(void){
    return RomDriver_HBN_Set_HRAM_slp();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Ldo11_All_Vout(uint8_t ldoLevel){
    return RomDriver_HBN_Set_Ldo11_All_Vout(ldoLevel);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Ldo11_Aon_Vout(uint8_t ldoLevel){
    return RomDriver_HBN_Set_Ldo11_Aon_Vout(ldoLevel);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Ldo11_Rt_Vout(uint8_t ldoLevel){
    return RomDriver_HBN_Set_Ldo11_Rt_Vout(ldoLevel);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Ldo11_Soc_Vout(uint8_t ldoLevel){
    return RomDriver_HBN_Set_Ldo11_Soc_Vout(ldoLevel);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Ldo18io_Power_Delay_Config(uint16_t pwrOffDly, uint16_t pwrOnDly){
    return RomDriver_HBN_Set_Ldo18io_Power_Delay_Config(pwrOffDly,pwrOnDly);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_MCU_Root_CLK_Sel(uint8_t rootClk){
    return RomDriver_HBN_Set_MCU_Root_CLK_Sel(rootClk);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_MCU_XCLK_Sel(uint8_t xclk){
    return RomDriver_HBN_Set_MCU_XCLK_Sel(xclk);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_PDS_Gpio_Keep(uint8_t gpioKeep){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_RTC_Timer(uint8_t delay, uint32_t compValLow, uint32_t compValHigh, uint8_t compMode){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Set_Xtal_Type(uint8_t xtalType){
    return RomDriver_HBN_Set_Xtal_Type(xtalType);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Trim_Ldo33VoutTrim(void){
    return RomDriver_HBN_Trim_Ldo33VoutTrim();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type HBN_Trim_RC32K(void){
...
/* L1C_CACHE_Cfg_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Default_Level_Config(PDS_DEFAULT_LV_CFG_Type *defaultLvCfg, uint32_t pdsSleepCnt){
    return RomDriver_PDS_Default_Level_Config(defaultLvCfg,pdsSleepCnt);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Disable_GPIO_Keep(void){
    return RomDriver_PDS_Disable_GPIO_Keep();
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Enable(PDS_CTL_Type *cfg, PDS_CTL4_Type *cfg4, uint32_t pdsSleepCnt){
    return RomDriver_PDS_Enable(cfg,cfg4,pdsSleepCnt);
}
#endif

/* PDS_CTL2_Type， PDS_CTL3_Type，PDS_CTL5_Type  do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Force_Config(PDS_CTL2_Type *cfg2, PDS_CTL3_Type *cfg3, PDS_CTL5_Type *cfg5){
    return RomDriver_PDS_Force_Config(cfg2,cfg3,cfg5);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_IntClear(void){
    return RomDriver_PDS_IntClear();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_IntMask(uint8_t intType, QC7XX_Mask_Type intMask){
    return RomDriver_PDS_IntMask(intType,intMask);
}

/* PDS_CTRL_RAM1_Type， PDS_CTRL_RAM2_Type，PDS_CTRL_RAM3_Type，PDS_CTRL_RAM4_Type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_RAM_Config(PDS_CTRL_RAM1_Type *ram1Cfg, PDS_CTRL_RAM2_Type *ram2Cfg, PDS_CTRL_RAM3_Type *ram3Cfg, PDS_CTRL_RAM4_Type *ram4Cfg){
    return RomDriver_PDS_RAM_Config(ram1Cfg,ram2Cfg,ram3Cfg,ram4Cfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_Flash_Pad_Pull_None(uint8_t pinCfg){
    return RomDriver_PDS_Set_Flash_Pad_Pull_None(pinCfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_Flash_Pad_Pull_None_Fast(uint8_t pinCfg){
    return RomDriver_PDS_Set_Flash_Pad_Pull_None_Fast(pinCfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_GPIO_Pad_IntClr(uint8_t set){
    return RomDriver_PDS_Set_GPIO_Pad_IntClr(set);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_GPIO_Pad_IntMask(uint8_t pad, QC7XX_Mask_Type intMask){
    return RomDriver_PDS_Set_GPIO_Pad_IntMask(pad,intMask);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_GPIO_Pad_IntMode(uint8_t set, uint8_t trig){
    return RomDriver_PDS_Set_GPIO_Pad_IntMode(set,trig);
}
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_GPIO_Pad_Pn_Pu_Pd_Ie(uint8_t grp, uint8_t pu, uint8_t pd, uint8_t ie){
    return RomDriver_PDS_Set_GPIO_Pad_Pn_Pu_Pd_Ie(grp,pu,pd,ie);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_MCU0_Clock_Disable(void){
    return RomDriver_PDS_Set_MCU0_Clock_Disable();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_MCU0_Clock_Enable(void){
    return RomDriver_PDS_Set_MCU0_Clock_Enable();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_MCU0_Reset_Address(uint32_t addr){
    return RomDriver_PDS_Set_MCU0_Reset_Address(addr);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_USB_Resume(void){
    return RomDriver_PDS_Set_USB_Resume();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Set_USB_Suspend(void){
    return RomDriver_PDS_Set_USB_Suspend();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Trim_RC32M(void){
    return RomDriver_PDS_Trim_RC32M();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Turn_Off_USB(void){
    return RomDriver_PDS_Turn_Off_USB();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type PDS_Turn_On_USB(uint8_t waitReady){
    return RomDriver_PDS_Turn_On_USB(waitReady);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Sts_Type PDS_Get_GPIO_Pad_IntStatus(uint8_t pad){
    return RomDriver_PDS_Get_GPIO_Pad_IntStatus(pad);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Sts_Type PDS_Get_IntStatus(uint8_t intType){
...
/* sf_ctrl_cfg_type，sf_ctrl_bank2_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sf_cfg_flash_init(uint8_t sel, const struct sf_ctrl_cfg_type *p_sf_ctrl_cfg, const struct sf_ctrl_bank2_cfg *p_bank2_cfg){
    return RomDriver_SF_Cfg_Flash_Init(sel,p_sf_ctrl_cfg,p_bank2_cfg);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sf_cfg_get_flash_cfg_need_lock(uint32_t flash_id, spi_flash_cfg_type *flash_cfg){
...
/* sf_ctrl_bank2_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
...
/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
uint32_t qc7xx_sf_cfg_flash_identify(uint8_t call_from_flash, uint8_t flash_pin_cfg, uint8_t restore_default, spi_flash_cfg_type *flash_cfg, uint8_t group, uint8_t bank){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
uint8_t qc7xx_sf_ctrl_is_sbus2_enable(void){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sf_ctrl_32bits_addr_en(uint8_t en_32bits_addr){
...
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sf_ctrl_aes_set_region(uint8_t region, uint8_t enable, uint8_t hwKey, uint32_t start_addr, uint32_t end_addr, uint8_t locked){
...
/* sf_ctrl_bank2_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sf_ctrl_bank2_enable(const struct sf_ctrl_bank2_cfg *bank2_cfg){
    return RomDriver_SF_Ctrl_Bank2_Enable(bank2_cfg);
}

/* sf_ctrl_cmds_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sf_ctrl_cmds_set(struct sf_ctrl_cmds_cfg *cmds_cfg, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_blk32_erase(spi_flash_cfg_type *flash_cfg, uint32_t blk_num){
...
/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_blk64_erase(spi_flash_cfg_type *flash_cfg, uint32_t blk_num){
    return RomDriver_SFlash_Blk64_Erase(flash_cfg,blk_num);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_chip_erase(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Chip_Erase(flash_cfg);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_erase(spi_flash_cfg_type *flash_cfg, uint32_t start_addr, uint32_t end_addr){
    return RomDriver_SFlash_Erase(flash_cfg,start_addr,end_addr);
}
#endif

/* spi_flash_cfg_type, sflash_sec_reg_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_erase_security_register(spi_flash_cfg_type *flash_cfg, struct sflash_sec_reg_cfg *p_sec_reg_cfg){
    return RomDriver_SFlash_Erase_Security_Register(flash_cfg,p_sec_reg_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_idbus_read_enable(spi_flash_cfg_type *flash_cfg, uint8_t io_mode, uint8_t cont_read, uint8_t bank){
    return RomDriver_SFlash_IDbus_Read_Enable(flash_cfg,io_mode,cont_read,bank);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_program(spi_flash_cfg_type *flash_cfg, uint8_t io_mode, uint32_t addr, uint8_t *data, uint32_t len){
    return RomDriver_SFlash_Program(flash_cfg,io_mode,addr,data,len);
}

/* spi_flash_cfg_type, sflash_sec_reg_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_program_security_register(spi_flash_cfg_type *flash_cfg, struct sflash_sec_reg_cfg *p_sec_reg_cfg){
    return RomDriver_SFlash_Program_Security_Register(flash_cfg,p_sec_reg_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_qspi_disable(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Qspi_Disable(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_qspi_enable(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Qspi_Enable(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_rcv_enable(spi_flash_cfg_type *flash_cfg, uint8_t r_cmd, uint8_t w_cmd, uint8_t bit_pos){
    return RomDriver_SFlash_RCV_Enable(flash_cfg,r_cmd,w_cmd,bit_pos);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_read(spi_flash_cfg_type *flash_cfg, uint8_t io_mode, uint8_t cont_read, uint32_t addr, uint8_t *data, uint32_t len){
    return RomDriver_SFlash_Read(flash_cfg,io_mode,cont_read,addr,data,len);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_read_reg(spi_flash_cfg_type *flash_cfg, uint8_t reg_index, uint8_t *reg_value, uint8_t reg_len){
    return RomDriver_SFlash_Read_Reg(flash_cfg,reg_index,reg_value,reg_len);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_read_reg_with_cmd(spi_flash_cfg_type *flash_cfg, uint8_t read_reg_cmd, uint8_t *reg_value, uint8_t reg_len){
    return RomDriver_SFlash_Read_Reg_With_Cmd(flash_cfg,read_reg_cmd,reg_value,reg_len);
}

/* sflash_sec_reg_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_read_security_register(struct sflash_sec_reg_cfg *p_sec_reg_cfg){
    return RomDriver_SFlash_Read_Security_Register(p_sec_reg_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_restore_from_powerdown(spi_flash_cfg_type *flash_cfg, uint8_t flash_cont_read, uint8_t bank){
    return RomDriver_SFlash_Restore_From_Powerdown(flash_cfg,flash_cont_read,bank);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_sector_erase(spi_flash_cfg_type *flash_cfg, uint32_t sec_num){
    return RomDriver_SFlash_Sector_Erase(flash_cfg,sec_num);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_set_32bits_addr_mode(spi_flash_cfg_type *flash_cfg, uint8_t en_32bits_addr){
    return RomDriver_SFlash_Set32BitsAddrMode(flash_cfg,en_32bits_addr);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_set_spi_mode(uint8_t mode){
    return RomDriver_SFlash_SetSPIMode(mode);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_set_xip_cfg(spi_flash_cfg_type *flash_cfg, uint8_t io_mode, uint8_t cont_read, uint32_t addr, uint32_t len, uint8_t bank){
    return RomDriver_SFlash_Set_IDbus_Cfg(flash_cfg,io_mode,cont_read,addr,len,bank);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_software_reset(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Software_Reset(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_write_enable(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Write_Enable(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_write_reg(spi_flash_cfg_type *flash_cfg, uint8_t reg_index, uint8_t *reg_value, uint8_t reg_len){
    return RomDriver_SFlash_Write_Reg(flash_cfg,reg_index,reg_value,reg_len);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_write_reg_with_cmd(spi_flash_cfg_type *flash_cfg, uint8_t write_reg_cmd, uint8_t *reg_value, uint8_t reg_len){
    return RomDriver_SFlash_Write_Reg_With_Cmd(flash_cfg,write_reg_cmd,reg_value,reg_len);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_sflash_busy(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Busy(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_disable_burst_wrap(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_DisableBurstWrap(flash_cfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_get_deviceid(uint8_t *data, uint8_t is_32bits_addr){
    return RomDriver_SFlash_GetDeviceId(data,is_32bits_addr);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_get_jedecid(spi_flash_cfg_type *flash_cfg, uint8_t *data){
    return RomDriver_SFlash_GetJedecId(flash_cfg,data);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_get_uniqueid(uint8_t *data, uint8_t id_len){
    return RomDriver_SFlash_GetUniqueId(data,id_len);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_idbus_read_disable(void){
    return RomDriver_SFlash_IDbus_Read_Disable();
}

/* sf_ctrl_cfg_type, sf_ctrl_bank2_cfg do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_init(const struct sf_ctrl_cfg_type *p_sf_ctrl_cfg, const struct sf_ctrl_bank2_cfg *p_bank2_cfg){
    return RomDriver_SFlash_Init(p_sf_ctrl_cfg,p_bank2_cfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_powerdown(void){
    return RomDriver_SFlash_Powerdown();
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_release_powerdown(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Release_Powerdown(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_reset_continue_read(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Reset_Continue_Read(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_set_burst_wrap(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_SetBurstWrap(flash_cfg);
}

/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_sflash_volatile_reg_write_enable(spi_flash_cfg_type *flash_cfg){
    return RomDriver_SFlash_Volatile_Reg_Write_Enable(flash_cfg);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_erase_need_lock(spi_flash_cfg_type *flash_cfg, uint32_t start_addr, int len, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_getdeviceid_need_lock(spi_flash_cfg_type *flash_cfg, QC7XX_Fun_Type is_32bits_addr, uint8_t *data, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_getjedecid_need_lock(spi_flash_cfg_type *flash_cfg, uint8_t *data, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_getuniqueid_need_lock(spi_flash_cfg_type *flash_cfg, uint8_t *data, uint8_t id_len, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_read_need_lock(spi_flash_cfg_type *flash_cfg, uint32_t addr, uint8_t *data, uint32_t len, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_read_via_cache_need_lock(uint32_t addr, uint8_t *data, uint32_t len){
...
/* spi_flash_cfg_type do not include enum type */
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_state_restore(spi_flash_cfg_type *flash_cfg, uint32_t offset, uint8_t group, uint8_t bank){
    return RomDriver_XIP_SFlash_State_Restore(flash_cfg,offset,group,bank);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_state_save(spi_flash_cfg_type *flash_cfg, uint32_t *offset, uint8_t group, uint8_t bank){
...
#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
int qc7xx_xip_sflash_write_need_lock(spi_flash_cfg_type *flash_cfg, uint32_t addr, uint8_t *data, uint32_t len, uint8_t group, uint8_t bank){
    return RomDriver_XIP_SFlash_Write_Need_Lock(flash_cfg,addr,data,len,group,bank);
}
#endif

__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_xip_sflash_opt_enter(uint8_t *aes_enable){
    return RomDriver_XIP_SFlash_Opt_Enter(aes_enable);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
void qc7xx_xip_sflash_opt_exit(uint8_t aes_enable){
    return RomDriver_XIP_SFlash_Opt_Exit(aes_enable);
}

#if 0
__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_Clr_GPIO_IntStatus(MD_GPIO_Type gpioPin){
    return RomDriver_MD_Clr_GPIO_IntStatus(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_Embedded_Flash_Pad_Enable(void){
    return RomDriver_MD_Embedded_Flash_Pad_Enable();
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Clr(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Clr(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Init(MD_GPIO_Cfg_Type *cfg){
    return RomDriver_MD_GPIO_Init(cfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Input_Disable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Input_Disable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Input_Enable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Input_Enable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_IntMask(MD_GPIO_Type gpioPin, QC7XX_Mask_Type intMask){
    return RomDriver_MD_GPIO_IntMask(gpioPin,intMask);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Int_Init(MD_GPIO_INT_Cfg_Type *intCfg){
    return RomDriver_MD_GPIO_Int_Init(intCfg);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Output_Disable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Output_Disable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Output_Enable(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Output_Enable(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Set(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Set(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Set_HZ(MD_GPIO_Type gpioPin){
    return RomDriver_MD_GPIO_Set_HZ(gpioPin);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Err_Type MD_GPIO_Write(MD_GPIO_Type gpioPin, uint32_t val){
    return RomDriver_MD_GPIO_Write(gpioPin,val);
}

__ALWAYS_INLINE ATTR_TCM_SECTION
QC7XX_Sts_Type MD_Get_GPIO_IntStatus(MD_GPIO_Type gpioPin){
