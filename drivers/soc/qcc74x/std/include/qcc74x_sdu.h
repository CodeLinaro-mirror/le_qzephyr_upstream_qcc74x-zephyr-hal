...
// SDIO I/O Enable
#define QC7XX_SDIO_IO_ENABLE           SDU_BASE + 0x00000002 
//CCCR (Fn0) Registers

// SDIO Device Sleep
#define QC7XX_SDIO_DEV_SLEEP           SDU_BASE + 0x00000092

// Start Address of CCR
#define QC7XX_SDIO_CCR_BASE            SDU_BASE + 0x00000100
// Address offset of CCR between two functions
#define QC7XX_SDIO_CCR_FUNC_OFFSET     0x00000100
...
#define QC7XX_FUNC_SCRATCH_BASE       SDU_BASE + 0x00000160
...
#define QC7XX_REGS8(x)     (*(volatile unsigned char *)(x))
#define QC7XX_REGS16(x)    (*(volatile unsigned short *)(x))
#define QC7XX_REGS32(x)    (*(volatile unsigned long *)(x))

#define QC7XX_READ_REGS8(reg,val)      ((val) = QC7XX_REGS8(reg))
#define QC7XX_READ_REGS16(reg,val)     ((val) = QC7XX_REGS16(reg))
#define QC7XX_READ_REGS32(reg,val)     ((val) = QC7XX_REGS32(reg))
#define QC7XX_READ_BYTE(reg,val)       ((val) = QC7XX_REGS8(reg))
#define QC7XX_READ_HWORD(reg,val)      ((val) = QC7XX_REGS16(reg)) /*half word; */
#define QC7XX_READ_WORD(reg,val)       ((val) = QC7XX_REGS32(reg)) /*32 bits */

#define QC7XX_WRITE_REGS8(reg,val)     (QC7XX_REGS8(reg) = (val))
#define QC7XX_WRITE_REGS16(reg,val)    (QC7XX_REGS16(reg) = (val))
#define QC7XX_WRITE_REGS32(reg,val)    (QC7XX_REGS32(reg) = (val))
#define QC7XX_WRITE_BYTE(reg,val)      (QC7XX_REGS8(reg) = (val))
#define QC7XX_WRITE_HWORD(reg,val)     (QC7XX_REGS16(reg) = (val))  /*half word; */
#define QC7XX_WRITE_WORD(reg,val)      (QC7XX_REGS32(reg) = (val))  /*32 bits */
// Write uint32 to a low 16-bit register and a high 16-bit register
#define WRITE2REGS(lo,hi,u32) \
    QC7XX_WRITE_HWORD(lo, (uint16_t)((u32) & 0xffff)); \
    QC7XX_WRITE_HWORD(hi, (uint16_t)(((u32) >> 16) & 0xffff))

#define QC7XX_REGS8_SETBITS(reg, val)  (QC7XX_REGS8(reg) |= (uint8)(val))
#define QC7XX_REGS16_SETBITS(reg, val) (QC7XX_REGS16(reg) |= (uint16)(val))
#define QC7XX_REGS32_SETBITS(reg, val) (QC7XX_REGS32(reg) |= (val))
#define QC7XX_REGS8_CLRBITS(reg, val)  (QC7XX_REGS8(reg) = (uint8)(QC7XX_REGS8(reg)&~(val)))
#define QC7XX_REGS16_CLRBITS(reg, val) (QC7XX_REGS16(reg) = (uint16)(QC7XX_REGS16(reg)&~(val)))
#define QC7XX_REGS32_CLRBITS(reg, val) (QC7XX_REGS32(reg) = (QC7XX_REGS32(reg)&~(val)))
