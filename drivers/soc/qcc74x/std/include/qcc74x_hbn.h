...
#ifndef __QCC74X_HBN_H__
#define __QCC74X_HBN_H__
...
QC7XX_Err_Type HBN_Get_Xtal_Value(uint32_t *xtalVal);
#if 0
QC7XX_Err_Type HBN_Set_Flash_Power_Delay(uint8_t flashPwrDly);
#endif
QC7XX_Err_Type HBN_Get_Flash_Power_Delay(uint8_t *flashPwrDly);
QC7XX_Err_Type HBN_Set_Reset_Reason(uint16_t rstReason);
QC7XX_Err_Type HBN_Get_Reset_Reason(uint16_t *rstReason);
...
QC7XX_Err_Type HBN_Recal_RC32K(int32_t expected_counter, int32_t actual_counter);
QC7XX_Err_Type HBN_Clear_RTC_IRQ(void);
/*----------*/
...
/*----------*/
QC7XX_Err_Type HBN_Set_Xtal_32K_Capbank(uint8_t value);
QC7XX_Err_Type HBN_Set_Xtal_32K_Inverter_Amplify_Strength(uint8_t value);
QC7XX_Err_Type HBN_Set_Xtal_32K_Regulator(uint8_t level);
