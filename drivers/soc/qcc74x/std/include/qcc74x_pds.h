...
#ifndef __QCC74X_PDS_H__
#define __QCC74X_PDS_H__
...
QC7XX_Err_Type PDS_Pu_PLL_Enable(void);
QC7XX_Err_Type PDS_Pu_PLL_Disable(void);
/*----------*/
...
QC7XX_Err_Type PDS_RAM_Config(PDS_CTRL_RAM1_Type *ram1Cfg, PDS_CTRL_RAM2_Type *ram2Cfg,
