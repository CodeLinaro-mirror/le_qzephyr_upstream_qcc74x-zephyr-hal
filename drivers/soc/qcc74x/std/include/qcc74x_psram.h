...
#ifndef __QCC74X_PSRAM_CTRL_H__
#define __QCC74X_PSRAM_CTRL_H__
...
#define QCC74X_PSRAM_GPIO41_REG_BASE 0x20000968
#define QCC74X_PSRAM_GPIO_IE_MASK    0x01
#define QCC74X_PSRAM_INIT_DONE       (                                                \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 0) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 1) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 2) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 3) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 4) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 5) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 6) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 7) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 8) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 9) & QCC74X_PSRAM_GPIO_IE_MASK) &&  \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 10) & QCC74X_PSRAM_GPIO_IE_MASK) && \
    (QC7XX_RD_WORD(QCC74X_PSRAM_GPIO41_REG_BASE + 4 * 11) & QCC74X_PSRAM_GPIO_IE_MASK))
...
typedef struct
{
    QC7XX_Fun_Type rst;                            /*!< Winbond pSRAM CR1 - Software Reset */
    PSRAM_Clock_Type clockType;                 /*!< Winbond pSRAM CR1 - Master Clock Type */
    QC7XX_Fun_Type inputPowerDownMode;             /*!< Winbond pSRAM CR1 - Input Power Down */
    QC7XX_Fun_Type linear_dis;                     /*!< Winbond pSRAM linear burst disable */
    QC7XX_Fun_Type hybridSleepMode;                /*!< Winbond pSRAM CR1 - Hybrid Sleep Mode configuration */
    PSRAM_Partial_Array_Refresh PASR;           /*!< Winbond pSRAM CR1 - Partial Array Refresh + Distributed Refresh Interval */
    QC7XX_Fun_Type disDeepPowerDownMode;           /*!< Winbond pSRAM CR0 - Deep Power-Down Disable configuration */
    QC7XX_Fun_Type fixedLatency;                   /*!< Winbond pSRAM CR1 - Fix Latency configuration */
...
typedef struct
{
    QC7XX_Fun_Type rst;                          /*!< AP Memory pSRAM configure global reset enable */
    QC7XX_Fun_Type fixedLatency;                 /*!< AP Memory pSRAM configure MR0 - read latency type */
    ...
    QC7XX_Fun_Type halfSleepModeEnable;          /*!< AP Memory pSRAM configure MR6 - Half Sleep enable */
    QC7XX_Fun_Type deepPowerDownModeEnable;      /*!< AP Memory pSRAM configure MR6 - Deep Power Down enable */
    QC7XX_Fun_Type crossBoundaryEnable;          /*!< AP Memory pSRAM configure MR8 - cross boundary enable 1'b0 - Read within 1K boundary 1'b1 -
...
QC7XX_Err_Type PSram_Ctrl_Winbond_Write_Reg(PSRAM_ID_Type PSRAM_ID, PSRAM_Ctrl_Winbond_Cfg_Reg_Type reg_addr,
...
QC7XX_Err_Type PSram_Ctrl_ApMem_Write_Reg(PSRAM_ID_Type PSRAM_ID, PSRAM_Ctrl_ApMem_Cfg_Reg_Type reg_addr,
