...
#endif
/**
 * @brief QCC74X Interrupt Number Definition, according to the selected device
...
#endif
#endif
    /******  QCC74X specific Interrupt Numbers **********************************************************************/
...
/**
 * @brief QCC74X Memory Map Definitions
 */
#define QCC74X_OCRAM_BASE                     (0x20FC0000)
#define QCC74X_OCRAM_END                      (0x20FC0000 + 320 * 1024)
#define QCC74X_OCRAM_CACHEABLE_BASE           (0x60FC0000)
#define QCC74X_OCRAM_CACHEABLE_END            (0x60FC0000 + 320 * 1024)
#define QCC74X_OCRAM_BUSREMAP_BASE            (0x22FC0000)
#define QCC74X_OCRAM_BUSREMAP_END             (0x22FC0000 + 320 * 1024)
#define QCC74X_OCRAM_BUSREMAP_CACHEABLE_BASE  (0x62FC0000)
#define QCC74X_OCRAM_BUSREMAP_CACHEABLE_END   (0x62FC0000 + 320 * 1024)

#define QCC74X_WRAM_BASE                      (0x21010000)
#define QCC74X_WRAM_END                       (0x21010000 + 160 * 1024)
#define QCC74X_WRAM_CACHEABLE_BASE            (0x61010000)
#define QCC74X_WRAM_CACHEABLE_END             (0x61010000 + 160 * 1024)
#define QCC74X_WRAM_BUSREMAP_BASE             (0x23010000)
#define QCC74X_WRAM_BUSREMAP_END              (0x23010000 + 160 * 1024)
#define QCC74X_WRAM_BUSREMAP_CACHEABLE_BASE   (0x63010000)
#define QCC74X_WRAM_BUSREMAP_CACHEABLE_END    (0x63010000 + 160 * 1024)

#define QCC74X_FLASH_XIP_BASE                 (0xA0000000)
#define QCC74X_FLASH_XIP_END                  (0xA0000000 + 64 * 1024 * 1024)
#define QCC74X_FLASH_XIP_REMAP0_BASE          (0xD0000000)
#define QCC74X_FLASH_XIP_REMAP0_END           (0xD0000000 + 64 * 1024 * 1024)
#define QCC74X_FLASH_XIP_BUSREMAP_BASE        (0xA0000000)
#define QCC74X_FLASH_XIP_BUSREMAP_END         (0xA0000000 + 64 * 1024 * 1024)

#define QCC74X_FLASH2_XIP_BASE                (0x84000000)
#define QCC74X_FLASH2_XIP_END                 (0x84000000 + 64 * 1024 * 1024)
#define QCC74X_FLASH2_XIP_REMAP0_BASE         (0xD4000000)
#define QCC74X_FLASH2_XIP_REMAP0_END          (0xD4000000 + 64 * 1024 * 1024)
#define QCC74X_FLASH2_XIP_BUSREMAP_BASE       (0xA4000000)
#define QCC74X_FLASH2_XIP_BUSREMAP_END        (0xA4000000 + 64 * 1024 * 1024)

#define QCC74X_PSRAM_BASE                     (0x88000000)
#define QCC74X_PSRAM_END                      (0x88000000 + 128 * 1024 * 1024)
#define QCC74X_PSRAM_REMAP0_BASE              (0xD8000000)
#define QCC74X_PSRAM_REMAP0_END               (0xD8000000 + 128 * 1024 * 1024)
#define QCC74X_PSRAM_BUSREMAP_BASE            (0xA8000000)
#define QCC74X_PSRAM_BUSREMAP_END             (0xA8000000 + 128 * 1024 * 1024)

#define QCC74X_ALLRAM_BASE                    (0x20FC0000)
#define QCC74X_ALLRAM_END                     (0x20FC0000 + 320 * 1024 + 160 * 1024)
#define QCC74X_ALLRAM_CACHEABLE_BASE          (0x60FC0000)
#define QCC74X_ALLRAM_CACHEABLE_END           (0x60FC0000 + 320 * 1024 + 160 * 1024)
#define QCC74X_ALLRAM_BUSREMAP_BASE           (0x22FC0000)
#define QCC74X_ALLRAM_BUSREMAP_END            (0x22FC0000 + 320 * 1024 + 160 * 1024)
#define QCC74X_ALLRAM_BUSREMAP_CACHEABLE_BASE (0x62FC0000)
#define QCC74X_ALLRAM_BUSREMAP_CACHEABLE_END  (0x62FC0000 + 320 * 1024 + 160 * 1024)

/*@} end of group Memory_Map_Section */

/* QCC74X peripherals base address */
/* WLSYS */
...
typedef enum {
    QC7XX_AHB_MASTER_CPU = 0x00,
    QC7XX_AHB_MASTER_SDU = 0x01,
    QC7XX_AHB_MASTER_SEC = 0x02,
    QC7XX_AHB_MASTER_DMA = 0x03,
    QC7XX_AHB_MASTER_CCI = 0x04,
    QC7XX_AHB_MASTER_WIFI_PLATFORM = 0x05,
    QC7XX_AHB_MASTER_WIFI_MAC_PHY = 0x06,
    QC7XX_AHB_MASTER_WIFI_PHY = 0x07,
    QC7XX_AHB_MASTER_MAX = 0x08,
} QC7XX_AHB_Master_Type;

typedef enum {
    QC7XX_AHB_SLAVE1_GLB = 0x00,    //cgen rsvd
    QC7XX_AHB_SLAVE1_RF_TOP = 0x01, //swrst mix
    QC7XX_AHB_SLAVE1_GPIP = 0x02,
    QC7XX_AHB_SLAVE1_SEC_DBG = 0x03,
    QC7XX_AHB_SLAVE1_SEC_ENG = 0x04,
    QC7XX_AHB_SLAVE1_TZ = 0x05,    //swrst tz1,cgen tz1+tz2
    QC7XX_AHB_SLAVE1_RSVD6 = 0x06, //swrst tz2,
    QC7XX_AHB_SLAVE1_EF_CTRL = 0x07,
    QC7XX_AHB_SLAVE1_CCI = 0x08, //cgen rsvd
    QC7XX_AHB_SLAVE1_L1C = 0x09, //cgen rsvd
    QC7XX_AHB_SLAVE1_RSVD10 = 0x0A,
    QC7XX_AHB_SLAVE1_SF_CTRL = 0x0B,
    QC7XX_AHB_SLAVE1_DMA = 0x0C,
    QC7XX_AHB_SLAVE1_SDU = 0x0D, //cgen rsvd
    QC7XX_AHB_SLAVE1_PDS = 0x0E, //cgen rsvd
    QC7XX_AHB_SLAVE1_RSVD15 = 0x0F,
    QC7XX_AHB_SLAVE1_UART0 = 0x10,
    QC7XX_AHB_SLAVE1_UART1 = 0x11,
    QC7XX_AHB_SLAVE1_SPI = 0x12,
    QC7XX_AHB_SLAVE1_I2C = 0x13,
    QC7XX_AHB_SLAVE1_PWM = 0x14,
    QC7XX_AHB_SLAVE1_TIMER = 0x15,
    QC7XX_AHB_SLAVE1_IRR = 0x16,
    QC7XX_AHB_SLAVE1_CKS = 0x17,
    QC7XX_AHB_SLAVE1_QDEC = 0x18,
    QC7XX_AHB_SLAVE1_KYS = 0x19,
    QC7XX_AHB_SLAVE1_UART2 = 0x1A,
    QC7XX_AHB_SLAVE1_RSVD27 = 0x1B,
    QC7XX_AHB_SLAVE1_RSVD28 = 0x1C,
    QC7XX_AHB_SLAVE1_RSVD29 = 0x1D,
    QC7XX_AHB_SLAVE1_RSVD30 = 0x1E,
    QC7XX_AHB_SLAVE1_RSVD31 = 0x1F,
    QC7XX_AHB_SLAVE1_MAX = 0x20,
    QC7XX_AHB_SLAVE1_GPADC = 0x21, /* not used for cgen and swrst */
    QC7XX_AHB_SLAVE1_GPDAC = 0x22, /* not used for cgen and swrst */
    QC7XX_AHB_SLAVE1_I2S = 0x23,   /* not used for cgen and swrst */
    QC7XX_AHB_SLAVE1_CAM = 0x24,   /* not used for cgen and swrst */
} QC7XX_AHB_Slave1_Type;

typedef enum {
    QC7XX_AHB_SLAVE2_RSVD0 = 0x00,
    QC7XX_AHB_SLAVE2_RSVD1 = 0x01,
    QC7XX_AHB_SLAVE2_RSVD2 = 0x02,
    QC7XX_AHB_SLAVE2_RSVD3 = 0x03,
    QC7XX_AHB_SLAVE2_WIFI = 0x04,
    QC7XX_AHB_SLAVE2_RSVD5 = 0x05,
    QC7XX_AHB_SLAVE2_RSVD6 = 0x06,
    QC7XX_AHB_SLAVE2_RSVD7 = 0x07,
    QC7XX_AHB_SLAVE2_BT_BLE = 0x08,
    QC7XX_AHB_SLAVE2_M154 = 0x09,
    QC7XX_AHB_SLAVE2_BT_BLE2 = 0x0A,
    QC7XX_AHB_SLAVE2_M1542 = 0x0B,
    QC7XX_AHB_SLAVE2_RSVD12 = 0x0C,
    QC7XX_AHB_SLAVE2_RSVD13 = 0x0D,
    QC7XX_AHB_SLAVE2_RSVD14 = 0x0E,
    QC7XX_AHB_SLAVE2_RSVD15 = 0x0F,
    QC7XX_AHB_SLAVE2_EXT_EMI_MISC = 0x10,
    QC7XX_AHB_SLAVE2_EXT_PSRAM0_CTRL = 0x11,
    QC7XX_AHB_SLAVE2_EXT_PSRAM1_CTRL = 0x12,
    QC7XX_AHB_SLAVE2_EXT_USB = 0x13,
    QC7XX_AHB_SLAVE2_EXT_MIX2 = 0x14,
    QC7XX_AHB_SLAVE2_EXT_AUDIO = 0x15,
    QC7XX_AHB_SLAVE2_EXT_SDH = 0x16,
    QC7XX_AHB_SLAVE2_EXT_EMAC = 0x17,
    QC7XX_AHB_SLAVE2_EXT_DMA2 = 0x18,
    QC7XX_AHB_SLAVE2_EXT_RSVD25 = 0x19,
    QC7XX_AHB_SLAVE2_EXT_RSVD26 = 0x1A,
    QC7XX_AHB_SLAVE2_EXT_RSVD27 = 0x1B,
    QC7XX_AHB_SLAVE2_MAX = 0x1C,
} QC7XX_AHB_Slave2_Type;

typedef enum {
    QC7XX_AHB_SEC_ENG_AES0 = 0,
    QC7XX_AHB_SEC_ENG_AES1,
    QC7XX_AHB_SEC_ENG_SHA0,
    QC7XX_AHB_SEC_ENG_SHA1,
} QC7XX_AHB_Sec_Eng_Type;

typedef enum {
    QC7XX_AHB_DMA0_CH0 = 0,
    QC7XX_AHB_DMA0_CH1,
    QC7XX_AHB_DMA0_CH2,
    QC7XX_AHB_DMA0_CH3,
    QC7XX_AHB_DMA0_CH4,
