...
#ifndef __QCC74X_EF_CTRL_H__
#define __QCC74X_EF_CTRL_H__
...
QC7XX_Fun_Type EF_Ctrl_Read_Bus_Remap(void);
...
QC7XX_Err_Type EF_Ctrl_Read_ZiggBee_MAC_Address(uint8_t mac[8]);
void EF_Ctrl_Writelock_MAC_Address(uint8_t program);
QC7XX_Err_Type EF_Ctrl_Read_Chip_ID(uint8_t id[8]);
