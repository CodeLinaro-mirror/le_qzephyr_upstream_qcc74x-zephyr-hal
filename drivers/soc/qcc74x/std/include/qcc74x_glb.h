...
#ifndef __QCC74X_GLB_H__
#define __QCC74X_GLB_H__
...
#define GLB_AHB_CLOCK_GPADC           (1ULL << GLB_AHB_CLOCK_IP_GPIP)
#define GLB_AHB_CLOCK_GPDAC           (1ULL << GLB_AHB_CLOCK_IP_GPIP)
...
/*----------*/
QC7XX_Err_Type GLB_Power_On_XTAL_And_PLL_CLK(uint8_t xtalType, uint8_t pllPuType);
...
QC7XX_Err_Type GLB_Set_MCU_MTimer_CLK(uint8_t enable, uint16_t div, uint8_t rst);
...
QC7XX_Err_Type GLB_Set_Flash_Id_Value(uint32_t idValue);
...
/*----------*/
QC7XX_Err_Type GLB_Config_WIFI_PLL(uint8_t xtalType, const GLB_WA_PLL_Cfg_Type *pllCfgList);
QC7XX_Err_Type GLB_Config_AUDIO_PLL(uint8_t xtalType, const GLB_WA_PLL_Cfg_Type *pllCfgList);
QC7XX_Err_Type GLB_Config_AUDIO_PLL_To_384M(void);
QC7XX_Err_Type GLB_Config_AUDIO_PLL_To_400M(void);

QC7XX_Err_Type GLB_Config_AUDIO_PLL_To_451P58M(void);
QC7XX_Err_Type GLB_Config_AUDIO_PLL_To_491P52M(void);
/*----------*/
void glb_40M_delay_us(uint32_t us);
QC7XX_Err_Type GLB_Fast_Power_On_WIFIPLL(const GLB_WA_PLL_Cfg_Type *const cfg, uint8_t waitStable);
QC7XX_Err_Type GLB_Fast_Power_On_XTAL_40M_And_WIFIPLL(void);
QC7XX_Err_Type GLB_Fast_Set_MCU_System_CLK_Div(uint8_t mcuClkDiv, uint8_t mcuPBclkDiv);
QC7XX_Err_Type GLB_Fast_Set_MCU_System_CLK(uint8_t clkFreq);
/*----------*/
uint8_t GLB_Get_Package_Type(void);
QC7XX_Sts_Type GLB_Get_PAD_Bonging_to_GND_Sts(void);
/*----------*/
