...
#ifndef __QCC74X_SDH_H__
#define __QCC74X_SDH_H__
...
typedef struct
{
    ...
    QC7XX_Fun_Type vlot18Enable;          /*!< SDH enable 1.8V */
    QC7XX_Fun_Type highSpeed;             /*!< SDH enable high speed */
...
typedef struct
{
    QC7XX_Fun_Type enableAutoCommand12; /*!< SDH enable auto CMD12 */
    QC7XX_Fun_Type enableAutoCommand23; /*!< SDH enable auto CMD23 */
    QC7XX_Fun_Type enableIgnoreError;   /*!< SDH enable to ignore error event to read/write all the data */
...
#define SDH_EnableIntStatus(mask)                                             \
    do {                                                                      \
        QC7XX_WR_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_EN,                      \
                  QC7XX_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_EN) | (mask)); \
    } while (0)
...
#define SDH_EnableIntSource(mask)                                                 \
    do {                                                                          \
        QC7XX_WR_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_INT_EN,                      \
                  QC7XX_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_INT_EN) | (mask)); \
    } while (0)
...
#define SDH_GetIntStatus()       QC7XX_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS);
#define SDH_GetIntEnableStatus() QC7XX_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_INT_EN);
#define SDH_ClearIntStatus(mask) QC7XX_WR_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS, (mask));
#define SDH_AutoCmd12ErrStatus() QC7XX_RD_SHORT(SDH_BASE + SDH_SD_AUTO_CMD12_ERROR_STATUS_OFFSET);
#define SDH_GetDMAErrStatus()    QC7XX_RD_SHORT(SDH_BASE + SDH_SD_ADMA_ERROR_STATUS_OFFSET);
#define SDH_GetPresentStatus()   QC7XX_RD_REG(SDH_BASE, SDH_SD_PRESENT_STATE_1);
