...
#ifndef __QCC74X_LP_H__
#define __QCC74X_LP_H__
#include <stdint.h>
...
typedef struct {
    ...
    uint8_t debug_io; /* reserved; kept for app/LPFW shared layout */
    ...
    /* iot2lp_para record info (internal) */
    struct qc7xx_lp_info_s *lp_info;
...
typedef int (*qc7xx_lp_cb_t)(void *arg);
...
/* Conversion of units */
#define QC7XX_US_TO_PDS_CNT(us)  ((us) * 512 / 15625)  /* us * 32768 / 1000 /1000 */
#define QC7XX_MS_TO_PDS_CNT(ms)  ((ms) * 4096 / 125)   /* ms * 32768 / 1000 */
#define QC7XX_PDS_CNT_TO_US(cnt) ((cnt) * 15625 / 512) /* cnt / 32768 * 1000 /1000 */
#define QC7XX_PDS_CNT_TO_MS(cnt) ((cnt) * 125 / 4096)  /* cnt / 32768 * 1000 */

/*  */
#define PROTECT_AF_MS         (10)
#define PROTECT_BF_MS         (5)

#define QC7XX_DTIM_NUM           (10)
...
extern qc7xx_lp_fw_cfg_t lpfw_cfg;
...
typedef struct {
    ...
    uint8_t hbn_level;
} qc7xx_lp_hbn_fw_cfg_t;

/******************** io wakeup cfg ********************/

#define QC7XX_LP_WAKEUP_IO_MAX_NUM                    35

/** @defgroup QC7XX_LP_IO_INPUT_EN input enable
  * @{
  */
#define QC7XX_LP_IO_INPUT_DISABLE                     0
#define QC7XX_LP_IO_INPUT_ENABLE                      1
/**
  * @}
  */

/** @defgroup QC7XX_LP_AON_IO_TRIG aon io wakeup trigger mode
  * @{
  */
#define QC7XX_LP_AON_IO_TRIG_SYNC_FALLING_EDGE        (0x0) /*!< AON_IO INT trigger type: sync falling edge trigger */
#define QC7XX_LP_AON_IO_TRIG_SYNC_RISING_EDGE         (0x1) /*!< AON_IO INT trigger type: sync rising edge trigger */
#define QC7XX_LP_AON_IO_TRIG_SYNC_LOW_LEVEL           (0x2) /*!< AON_IO INT trigger type: sync low level trigger */
#define QC7XX_LP_AON_IO_TRIG_SYNC_HIGH_LEVEL          (0x3) /*!< AON_IO INT trigger type: sync high level trigger */
#define QC7XX_LP_AON_IO_TRIG_SYNC_RISING_FALLING_EDGE (0x4) /*!< AON_IO INT trigger type: sync rising falling edge trigger */
#define QC7XX_LP_AON_IO_TRIG_ASYNC_FALLING_EDGE       (0x8) /*!< AON_IO INT trigger type: async falling edge trigger */
#define QC7XX_LP_AON_IO_TRIG_ASYNC_RISING_EDGE        (0x9) /*!< AON_IO INT trigger type: async rising edge trigger */
#define QC7XX_LP_AON_IO_TRIG_ASYNC_LOW_LEVEL          (0xA) /*!< AON_IO INT trigger type: async low level trigger */
#define QC7XX_LP_AON_IO_TRIG_ASYNC_HIGH_LEVEL         (0xB) /*!< AON_IO INT trigger type: async high level trigger */
#define QC7XX_LP_AON_IO_TRIG_NONE                     (0xF) /*!< AON_IO INT trigger type: none */
/**
  * @}
  */

/** @defgroup QC7XX_LP_PDS_IO_TRIG aon io wakeup trigger mode
  * @{
  */
#define QC7XX_LP_PDS_IO_TRIG_SYNC_FALLING_EDGE        (0x0) /*!< PDS_IO INT trigger type: sync falling edge trigger */
#define QC7XX_LP_PDS_IO_TRIG_SYNC_RISING_EDGE         (0x1) /*!< PDS_IO INT trigger type: sync rising edge trigger */
#define QC7XX_LP_PDS_IO_TRIG_SYNC_HIGH_LEVEL          (0x3) /*!< PDS_IO INT trigger type: sync high level trigger */
#define QC7XX_LP_PDS_IO_TRIG_ASYNC_FALLING_EDGE       (0x8) /*!< PDS_IO INT trigger type: async falling edge trigger */
#define QC7XX_LP_PDS_IO_TRIG_ASYNC_RISING_EDGE        (0x9) /*!< PDS_IO INT trigger type: async rising edge trigger */
#define QC7XX_LP_PDS_IO_TRIG_ASYNC_HIGH_LEVEL         (0xB) /*!< PDS_IO INT trigger type: async high level trigger */
#define QC7XX_LP_PDS_IO_TRIG_NONE                     (0xF) /*!< PDS_IO INT trigger type: none */
/**
  * @}
  */

/** @defgroup QC7XX_LP_RES resistors select
  * @{
  */
#define QC7XX_LP_IO_RES_PULL_UP                       1
#define QC7XX_LP_IO_RES_PULL_DOWN                     2
#define QC7XX_LP_IO_RES_NONE                          3
/**
  * @}
  */

typedef struct {
    /* input enable, use @ref QC7XX_LP_IO_INPUT_EN */
    uint8_t io_0_15_ie;
    uint8_t io_16_ie;
    uint8_t io_17_ie;
    uint8_t io_18_ie;
    ...
    /* trigger mode */
    uint8_t io_0_7_pds_trig_mode;   /* use @ref QC7XX_LP_PDS_IO_TRIG */
    uint8_t io_8_15_pds_trig_mode;  /* use @ref QC7XX_LP_PDS_IO_TRIG */
    uint8_t io_16_19_aon_trig_mode; /* aon io, use @ref QC7XX_LP_AON_IO_TRIG, full mode support */
    uint8_t io_20_27_pds_trig_mode; /* use @ref QC7XX_LP_PDS_IO_TRIG */
    uint8_t io_28_34_pds_trig_mode; /* use @ref QC7XX_LP_PDS_IO_TRIG */
...
typedef struct {
    ...
    uint8_t unmask;
    uint8_t trigMode;
} qc7xx_lp_aon_io_cfg_t;

#define QC7XX_LP_IO_WAKEUP_MODE_LOW             1
#define QC7XX_LP_IO_WAKEUP_MODE_HIGH            2
#define QC7XX_LP_IO_WAKEUP_MODE_FALLING         3
#define QC7XX_LP_IO_WAKEUP_MODE_RISING          4

/******************** acomp wakeup cfg ********************/

#define QC7XX_LP_WAKEUP_ACOMP_MAX_NUM           2

/** @defgroup QC7XX_LP_ACOMP_EN acomp input enable
  * @{
  */
#define QC7XX_LP_ACOMP_DISABLE                  0
#define QC7XX_LP_ACOMP_ENABLE                   1
/**
  * @}
  */

/** @defgroup QC7XX_LP_ACOMP_TRIG acomp wakeup trigger mode
  * @{
  */
#define QC7XX_LP_ACOMP_TRIG_EDGE_FALLING        1
#define QC7XX_LP_ACOMP_TRIG_EDGE_RISING         2
#define QC7XX_LP_ACOMP_TRIG_EDGE_FALLING_RISING 3
/**
  * @}
  */

typedef struct {
    /* input enable, use @ref QC7XX_LP_ACOMP_EN */
    uint8_t acomp0_en;
    uint8_t acomp1_en;
    ...
    /* trigger mode, use @ref QC7XX_LP_ACOMP_TRIG  */
    uint8_t acomp0_trig_mode;
    uint8_t acomp1_trig_mode;

} qc7xx_lp_acomp_cfg_t;

#define QC7XX_LP_ACOMP_WAKEUP_MODE_FALLING 1
#define QC7XX_LP_ACOMP_WAKEUP_MODE_RISING  2

/******************** acomp end ********************/

#define QC7XX_LP_SOFT_INT_TRIG             (csi_vic_set_pending_irq(MSOFT_IRQn))
#define QC7XX_LP_SOFT_INT_CLEAR            (csi_vic_clear_pending_irq(MSOFT_IRQn))

typedef struct {
    void (*wakeup_io_callback)(uint64_t wake_up_io_bits);
    void (*wakeup_acomp_callback)(uint32_t wake_up_acomp);
} qc7xx_lp_soft_irq_callback_t;
...
int qc7xx_lp_fw_enter(qc7xx_lp_fw_cfg_t *qc7xx_lp_fw_cfg);
...
int qc7xx_lp_update_beacon_stamp(uint64_t beacon_timestamp);
void qc7xx_lp_rtc_use_xtal32K(void);
void qc7xx_lp_rtc_use_rc32k(void);
...
void qc7xx_lp_xip_recovery(void);
