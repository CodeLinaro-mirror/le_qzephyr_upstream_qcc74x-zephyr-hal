 ...
 *
*******************************************************************************/
#ifdef romapi_qc7xx_sflash_init
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_init(const struct sf_ctrl_cfg_type *p_sf_ctrl_cfg,
                                       const struct sf_ctrl_bank2_cfg *p_bank2_cfg)
{
    return romapi_qc7xx_sflash_init(p_sf_ctrl_cfg, p_bank2_cfg);
}
#else
__WEAK
                                       ...
                                       const struct sf_ctrl_bank2_cfg *p_bank2_cfg)
{
    ...
    if (p_bank2_cfg != NULL) {
        if (p_bank2_cfg->sbus2_select) {
            ...
            qc7xx_sf_ctrl_sbus2_set_delay(clk_delay, rx_clk_invert);
        } else {
            qc7xx_sf_ctrl_sbus2_revoke_replace();
        }

        qc7xx_sf_ctrl_bank2_enable(p_bank2_cfg);
    } else {
        qc7xx_sf_ctrl_sbus2_revoke_replace();
    }
#endif
...
void ATTR_TCM_SECTION qc7xx_sflash_init(const struct sf_ctrl_cfg_type *p_sf_ctrl_cfg)
{
    ...
    if (p_sf_ctrl_cfg != NULL) {
        qc7xx_sf_ctrl_enable(p_sf_ctrl_cfg);
    }
}
#endif
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_set_spi_mode(uint8_t mode)
{
#ifdef romapi_qc7xx_sflash_set_spi_mode
    return romapi_qc7xx_sflash_set_spi_mode(mode);
#else
    int stat = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_read_reg(spi_flash_cfg_type *flash_cfg, uint8_t reg_index,
                                          uint8_t *reg_value, uint8_t reg_len)
{
#ifdef romapi_qc7xx_sflash_read_reg
    return romapi_qc7xx_sflash_read_reg(flash_cfg, reg_index, reg_value, reg_len);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_write_reg(spi_flash_cfg_type *flash_cfg, uint8_t reg_index,
                                           uint8_t *reg_value, uint8_t reg_len)
{
#ifdef romapi_qc7xx_sflash_write_reg
    return romapi_qc7xx_sflash_write_reg(flash_cfg, reg_index, reg_value, reg_len);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint32_t cnt = 0;
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    ...
    while (qc7xx_sflash_busy(flash_cfg)) {
        arch_delay_us(100);
        cnt++;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_read_reg_with_cmd(spi_flash_cfg_type *flash_cfg,
                                                   uint8_t read_reg_cmd, uint8_t *reg_value, uint8_t reg_len)
{
#ifdef romapi_qc7xx_sflash_read_reg_with_cmd
    return romapi_qc7xx_sflash_read_reg_with_cmd(flash_cfg, read_reg_cmd, reg_value, reg_len);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    uint32_t cnt = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_write_reg_with_cmd(spi_flash_cfg_type *flash_cfg,
                                                    uint8_t write_reg_cmd, uint8_t *reg_value, uint8_t reg_len)
{
#ifdef romapi_qc7xx_sflash_write_reg_with_cmd
    return romapi_qc7xx_sflash_write_reg_with_cmd(flash_cfg, write_reg_cmd, reg_value, reg_len);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint32_t cnt = 0;
    struct sf_ctrl_cmd_cfg_type flash_cmd;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_busy(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_busy
    return romapi_qc7xx_sflash_busy(flash_cfg);
#else
    uint32_t stat = 0;
    qc7xx_sflash_read_reg(flash_cfg, flash_cfg->busy_index, (uint8_t *)&stat, flash_cfg->busy_read_reg_len);
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_write_enable(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_write_enable
    return romapi_qc7xx_sflash_write_enable(flash_cfg);
#else
    uint32_t stat = 0;
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    ...
    qc7xx_sflash_read_reg(flash_cfg, flash_cfg->wr_enable_index, (uint8_t *)&stat, flash_cfg->wr_enable_read_reg_len);
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_qspi_enable(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_qspi_enable
    return romapi_qc7xx_sflash_qspi_enable(flash_cfg);
#else
    ...
    if (flash_cfg->qe_read_reg_len == 0) {
        ...
        qc7xx_sflash_write_reg(flash_cfg, flash_cfg->qe_index, (uint8_t *)&stat, flash_cfg->qe_write_reg_len);
        return 0;
    }

    qc7xx_sflash_read_reg(flash_cfg, flash_cfg->qe_index, (uint8_t *)&stat, flash_cfg->qe_read_reg_len);
    ...
    if (flash_cfg->qe_write_reg_len != 1) {
        ...
        qc7xx_sflash_read_reg(flash_cfg, 0, (uint8_t *)&stat, 1);
        qc7xx_sflash_read_reg(flash_cfg, 1, ((uint8_t *)&stat) + 1, 1);
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_qspi_disable(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_qspi_disable
    return romapi_qc7xx_sflash_qspi_disable(flash_cfg);
#else
    uint32_t stat = 0, ret = 0;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_volatile_reg_write_enable(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_volatile_reg_write_enable
    romapi_qc7xx_sflash_volatile_reg_write_enable(flash_cfg);
#else
    struct sf_ctrl_cmd_cfg_type flash_cmd;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_chip_erase(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_chip_erase
    return romapi_qc7xx_sflash_chip_erase(flash_cfg);
#else
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    uint32_t cnt = 0;
    uint32_t timeout = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_sector_erase(spi_flash_cfg_type *flash_cfg, uint32_t sector_num)
{
#ifdef romapi_qc7xx_sflash_sector_erase
    return romapi_qc7xx_sflash_sector_erase(flash_cfg, sector_num);
#else
    uint32_t cnt = 0;
...
{
#ifdef romapi_qc7xx_sflash_blk32_erase
    return romapi_qc7xx_sflash_blk32_erase(flash_cfg, blk_num);
#else
    uint32_t cnt = 0;
    uint8_t is_32bits_addr = 0;
    struct sf_ctrl_cmd_cfg_type flash_cmd;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_blk64_erase(spi_flash_cfg_type *flash_cfg, uint32_t blk_num)
{
#ifdef romapi_qc7xx_sflash_blk64_erase
    return romapi_qc7xx_sflash_blk64_erase(flash_cfg, blk_num);
#else
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    uint32_t cnt = 0;
    uint8_t is_32bits_addr = 0;
    ...
    if (is_32bits_addr > 0) {
        flash_cmd.addr_size++;
        flash_cmd.cmd_buf[0] = (flash_cfg->blk64_erase_cmd << 24) | ((QC7XX_SPIFLASH_BLK64K_SIZE * blk_num) >> 8);
        flash_cmd.cmd_buf[1] = ((QC7XX_SPIFLASH_BLK64K_SIZE * blk_num) << 24);
    } else {
        flash_cmd.cmd_buf[0] = (flash_cfg->blk64_erase_cmd << 24) | (QC7XX_SPIFLASH_BLK64K_SIZE * blk_num);
    }
...
{
#ifdef romapi_qc7xx_sflash_erase
    return romapi_qc7xx_sflash_erase(flash_cfg, start_addr, end_addr);
#else
    uint32_t len = 0;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_get_uniqueid(uint8_t *data, uint8_t id_len)
{
#ifdef romapi_qc7xx_sflash_get_uniqueid
    romapi_qc7xx_sflash_get_uniqueid(data, id_len);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_get_jedecid(spi_flash_cfg_type *flash_cfg, uint8_t *data)
{
#ifdef romapi_qc7xx_sflash_get_jedecid
    romapi_qc7xx_sflash_get_jedecid(flash_cfg, data);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint8_t cmd = 0, dummy_clks = 0;
    uint32_t timeout = 0;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_get_deviceid(uint8_t *data, uint8_t is_32bits_addr)
{
#ifdef romapi_qc7xx_sflash_get_deviceid
    romapi_qc7xx_sflash_get_deviceid(data, is_32bits_addr);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint8_t cmd = 0, dummy_clks = 0;
    uint32_t timeout = 0;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_powerdown(void)
{
#ifdef romapi_qc7xx_sflash_powerdown
    romapi_qc7xx_sflash_powerdown();
#else
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    uint8_t cmd = 0;
    uint32_t timeout = 0;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_release_powerdown(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_release_powerdown
    romapi_qc7xx_sflash_release_powerdown(flash_cfg);
#else
    uint8_t cmd = 0;
    uint32_t timeout = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_restore_from_powerdown(spi_flash_cfg_type *flash_cfg,
                                                        uint8_t flash_cont_read, uint8_t bank)
{
#ifdef romapi_qc7xx_sflash_restore_from_powerdown
    return romapi_qc7xx_sflash_restore_from_powerdown(flash_cfg, flash_cont_read, bank);
#else
    int stat = 0;
    uint32_t jedecid = 0;
    uint8_t tmp[8];
    ...
    qc7xx_sflash_release_powerdown(flash_cfg);
    arch_delay_us(120);

    qc7xx_sflash_get_jedecid(flash_cfg, (uint8_t *)&jedecid);

    if (SF_CTRL_QO_MODE == io_mode || SF_CTRL_QIO_MODE == io_mode) {
        qc7xx_sflash_qspi_enable(flash_cfg);
    }
    ...
    if (((flash_cfg->io_mode >> 4) & 0x01) == 1) {
        ...
        qc7xx_sflash_write_enable(flash_cfg);
        qc7xx_sflash_set_burst_wrap(flash_cfg);
    }

    if (flash_cont_read) {
        stat = qc7xx_sflash_read(flash_cfg, io_mode, 1, 0x00000000, (uint8_t *)tmp, sizeof(tmp));
        stat = qc7xx_sflash_set_xip_cfg(flash_cfg, io_mode, 1, 0, 32, bank);
    } else {
        stat = qc7xx_sflash_set_xip_cfg(flash_cfg, io_mode, 0, 0, 32, bank);
    }
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_set_burst_wrap(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_set_burst_wrap
    romapi_qc7xx_sflash_set_burst_wrap(flash_cfg);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint8_t cmd = 0, dummy_clks = 0;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_disable_burst_wrap(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_disable_burst_wrap
    romapi_qc7xx_sflash_disable_burst_wrap(flash_cfg);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint8_t cmd = 0, dummy_clks = 0;
    uint32_t wrap_data = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_set_32bits_addr_mode(spi_flash_cfg_type *flash_cfg,
                                                      uint8_t en_32bits_addr)
{
#ifdef romapi_qc7xx_sflash_set_32bits_addr_mode
    return romapi_qc7xx_sflash_set_32bits_addr_mode(flash_cfg, en_32bits_addr);
#else
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    uint8_t cmd = 0;
    ...
    qc7xx_sf_ctrl_32bits_addr_en(en_32bits_addr);
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_software_reset(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_software_reset
    return romapi_qc7xx_sflash_software_reset(flash_cfg);
#else
    uint16_t cnt = 0;
    struct sf_ctrl_cmd_cfg_type flash_cmd;
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_reset_continue_read(spi_flash_cfg_type *flash_cfg)
{
#ifdef romapi_qc7xx_sflash_reset_continue_read
    romapi_qc7xx_sflash_reset_continue_read(flash_cfg);
#else
    struct sf_ctrl_cmd_cfg_type flash_cmd;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_set_xip_cfg(spi_flash_cfg_type *flash_cfg, uint8_t io_mode,
                                             uint8_t cont_read, uint32_t addr, uint32_t len, uint8_t bank)
{
#ifdef romapi_qc7xx_sflash_set_xip_cfg
    return romapi_qc7xx_sflash_set_xip_cfg(flash_cfg, io_mode, cont_read, addr, len, bank);
#else
    uint8_t cmd = 0, dummy_clks = 0;
    struct sf_ctrl_cmd_cfg_type flash_cmd;
    uint8_t cmd_valid = 1;
    ...
    if (bank == SF_CTRL_FLASH_BANK0) {
        qc7xx_sf_ctrl_xip_set(&flash_cmd, cmd_valid);
    } else {
        qc7xx_sf_ctrl_xip2_set(&flash_cmd, cmd_valid);
    }
#else
    qc7xx_sf_ctrl_xip_set(&flash_cmd, cmd_valid);
#endif
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_xip_read_enable(spi_flash_cfg_type *flash_cfg,
                                                 uint8_t io_mode, uint8_t cont_read, uint8_t bank)
{
#ifdef romapi_qc7xx_sflash_xip_read_enable
    return romapi_qc7xx_sflash_xip_read_enable(flash_cfg, io_mode, cont_read, bank);
#else
    int stat = 0;

    stat = qc7xx_sflash_set_xip_cfg(flash_cfg, io_mode, cont_read, 0, 32, bank);
    if (0 != stat) {
        return stat;
    }
...
*******************************************************************************/
__WEAK
void ATTR_TCM_SECTION qc7xx_sflash_xip_read_disable(void)
{
#ifdef romapi_qc7xx_sflash_xip_read_disable
    return romapi_qc7xx_sflash_xip_read_disable();
#else
#endif
}
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_rcv_enable(spi_flash_cfg_type *flash_cfg, uint8_t r_cmd,
                                            uint8_t w_cmd, uint8_t bit_pos)
{
#ifdef romapi_qc7xx_sflash_rcv_enable
    return romapi_qc7xx_sflash_rcv_enable(flash_cfg, r_cmd, w_cmd, bit_pos);
#else
    int stat = 0;
    uint32_t cnt = 0;
    uint32_t temp_val = 0;
    ...
    stat = qc7xx_sflash_read_reg_with_cmd(flash_cfg, r_cmd, (uint8_t *)&temp_val, 1);
    if (0 != stat) {
        stat = -1;
    }
    ...
    stat = qc7xx_sflash_write_enable(flash_cfg);
    if (0 != stat) {
        stat = -1;
    }

    stat = qc7xx_sflash_write_reg_with_cmd(flash_cfg, w_cmd, (uint8_t *)&temp_val, 1);
    if (0 != stat) {
        return stat;
    }
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_erase_security_register(spi_flash_cfg_type *flash_cfg,
                                                         struct sflash_sec_reg_cfg *p_sec_reg_cfg)
{
#ifdef romapi_qc7xx_sflash_erase_security_register
    return romapi_qc7xx_sflash_erase_security_register(flash_cfg, p_sec_reg_cfg);
#else
    int stat = 0;
    uint32_t cnt = 0;
    uint8_t cmd = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_program_security_register(spi_flash_cfg_type *flash_cfg,
                                                           struct sflash_sec_reg_cfg *p_sec_reg_cfg)
{
#ifdef romapi_qc7xx_sflash_program_security_register
    return romapi_qc7xx_sflash_program_security_register(flash_cfg, p_sec_reg_cfg);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_read_security_register(struct sflash_sec_reg_cfg *p_sec_reg_cfg)
{
#ifdef romapi_qc7xx_sflash_read_security_register
    return romapi_qc7xx_sflash_read_security_register(p_sec_reg_cfg);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
...
{
#ifdef romapi_qc7xx_sflash_clear_status_register
    return romapi_qc7xx_sflash_clear_status_register(flash_cfg);
#else
    uint32_t ret = 0;
    uint32_t qe_value = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_read(spi_flash_cfg_type *flash_cfg, uint8_t io_mode,
                                      uint8_t cont_read, uint32_t addr, uint8_t *data, uint32_t len)
{
#ifdef romapi_qc7xx_sflash_read
    return romapi_qc7xx_sflash_read(flash_cfg, io_mode, cont_read, addr, data, len);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint32_t cur_len = 0, i = 0;
    uint8_t cmd = 0, dummy_clks = 0;
...
*******************************************************************************/
__WEAK
int ATTR_TCM_SECTION qc7xx_sflash_program(spi_flash_cfg_type *flash_cfg, uint8_t io_mode,
                                         uint32_t addr, uint8_t *data, uint32_t len)
{
#ifdef romapi_qc7xx_sflash_program
    return romapi_qc7xx_sflash_program(flash_cfg, io_mode, addr, data, len);
#else
    uint8_t *const flash_ctrl_buf = (uint8_t *)QC7XX_SF_CTRL_BUF_BASE;
    uint32_t i = 0, cur_len = 0;
    uint32_t cnt = 0;
