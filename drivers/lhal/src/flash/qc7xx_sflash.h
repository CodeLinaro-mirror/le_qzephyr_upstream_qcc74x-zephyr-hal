...
#ifndef _QC7XX_SFLASH_H
#define _QC7XX_SFLASH_H
 ...
 *  @{
 */
#define QC7XX_SPIFLASH_BLK32K_SIZE (32 * 1024)
#define QC7XX_SPIFLASH_BLK64K_SIZE (64 * 1024)
#define QC7XX_SPIFLASH_CMD_INVALID 0xff
...
#else
void qc7xx_sflash_init(const struct sf_ctrl_cfg_type *p_sf_ctrl_cfg);
#endif
...
int qc7xx_sflash_read_reg_with_cmd(spi_flash_cfg_type *flash_cfg, uint8_t read_reg_cmd, uint8_t *reg_value,
                                      uint8_t reg_len);
int qc7xx_sflash_write_reg_with_cmd(spi_flash_cfg_type *flash_cfg, uint8_t write_reg_cmd, uint8_t *reg_value,
                                       uint8_t reg_len);
...
int qc7xx_sflash_sector_erase(spi_flash_cfg_type *flash_cfg, uint32_t sector_num);
...
int qc7xx_sflash_set_xip_cfg(spi_flash_cfg_type *flash_cfg, uint8_t io_mode, uint8_t cont_read, uint32_t addr,
                            uint32_t len, uint8_t bank);
int qc7xx_sflash_xip_read_enable(spi_flash_cfg_type *flash_cfg, uint8_t io_mode, uint8_t cont_read, uint8_t bank);
void qc7xx_sflash_xip_read_disable(void);
...
int qc7xx_sflash_clear_status_register(spi_flash_cfg_type *flash_cfg);
int qc7xx_sflash_read(spi_flash_cfg_type *flash_cfg, uint8_t io_mode, uint8_t cont_read, uint32_t addr, uint8_t *data,
                         uint32_t len);
