...
#ifdef romapi_qc7xx_wdg_init
    romapi_qc7xx_wdg_init(dev, config);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qc7xx_wdg_start
    romapi_qc7xx_wdg_start(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qc7xx_wdg_stop
    romapi_qc7xx_wdg_stop(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qc7xx_wdg_get_countervalue
    return romapi_qc7xx_wdg_get_countervalue(dev);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qc7xx_wdg_set_countervalue
    romapi_qc7xx_wdg_set_countervalue(dev, value);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qc7xx_wdg_reset_countervalue
    romapi_qc7xx_wdg_reset_countervalue(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qc7xx_wdg_compint_clear
    romapi_qc7xx_wdg_compint_clear(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
