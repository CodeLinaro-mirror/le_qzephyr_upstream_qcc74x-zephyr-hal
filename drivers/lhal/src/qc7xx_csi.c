...
static void qc7xx_csi_phy_config(struct qc7xx_device_s *dev, uint32_t tx_clk_escape, uint32_t data_rate)
{
    uint32_t reg_base;
    uint32_t regval;
...
void qc7xx_csi_init(struct qc7xx_device_s *dev, const struct qc7xx_csi_config_s *config)
{
    ...
    qc7xx_csi_phy_config(dev, config->tx_clk_escape / 1000000, config->data_rate / 1000000);
