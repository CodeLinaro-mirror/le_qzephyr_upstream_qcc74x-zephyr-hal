...
#include "qc7xx_pwm_v2.h"
#include "qc7xx_clock.h"
#include "hardware/pwm_v2_reg.h"

void qc7xx_pwm_v2_init(struct qc7xx_device_s *dev, const struct qc7xx_pwm_v2_config_s *config)
{
...
#ifdef romapi_qc7xx_pwm_v2_init
    romapi_qc7xx_pwm_v2_init(dev, config);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
    ...
    if (config->clk_source == QC7XX_SYSTEM_XCLK) {
        regval |= (0 << PWM_REG_CLK_SEL_SHIFT);
    } else if (config->clk_source == QC7XX_SYSTEM_PBCLK) {
        regval |= (1 << PWM_REG_CLK_SEL_SHIFT);
    } else if (config->clk_source == QC7XX_SYSTEM_32K_CLK) {
...
void qc7xx_pwm_v2_deinit(struct qc7xx_device_s *dev)
{
#ifdef romapi_qc7xx_pwm_v2_deinit
    romapi_qc7xx_pwm_v2_deinit(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
...
void qc7xx_pwm_v2_set_period(struct qc7xx_device_s *dev, uint16_t period)
{
#ifdef romapi_qc7xx_pwm_v2_set_period
    romapi_qc7xx_pwm_v2_set_period(dev, period);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qc7xx_pwm_v2_start(struct qc7xx_device_s *dev)
{
#ifdef romapi_qc7xx_pwm_v2_start
    romapi_qc7xx_pwm_v2_start(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
...
void qc7xx_pwm_v2_stop(struct qc7xx_device_s *dev)
{
#ifdef romapi_qc7xx_pwm_v2_stop
    romapi_qc7xx_pwm_v2_stop(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint64_t start_time;
...
float qc7xx_pwm_v2_get_frequency(struct qc7xx_device_s *dev)
{
#ifdef romapi_qc7xx_pwm_v2_get_frequency
    return romapi_qc7xx_pwm_v2_get_frequency(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint32_t tmp;
    ...
    switch (tmp) {
        case 0:
            src = (float)qc7xx_clk_get_system_clock(QC7XX_SYSTEM_XCLK);
            break;
        case 1:
            src = (float)qc7xx_clk_get_system_clock(QC7XX_SYSTEM_PBCLK);
            break;
        default:
            src = (float)qc7xx_clk_get_system_clock(QC7XX_SYSTEM_32K_CLK);
            break;
    }
    /* get clock dividor */
...
void qc7xx_pwm_v2_channel_init(struct qc7xx_device_s *dev, uint8_t ch, struct qc7xx_pwm_v2_channel_config_s *config)
{
#ifdef romapi_qc7xx_pwm_v2_channel_init
    romapi_qc7xx_pwm_v2_channel_init(dev, ch, config);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qc7xx_pwm_v2_channel_set_threshold(struct qc7xx_device_s *dev, uint8_t ch, uint16_t low_threhold, uint16_t high_threhold)
{
#ifdef romapi_qc7xx_pwm_v2_channel_set_threshold
    romapi_qc7xx_pwm_v2_channel_set_threshold(dev, ch, low_threhold, high_threhold);
#else
    uint32_t regval;
...
void qc7xx_pwm_v2_channel_positive_start(struct qc7xx_device_s *dev, uint8_t ch)
{
#ifdef romapi_qc7xx_pwm_v2_channel_positive_start
    romapi_qc7xx_pwm_v2_channel_positive_start(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qc7xx_pwm_v2_channel_negative_start(struct qc7xx_device_s *dev, uint8_t ch)
{
#ifdef romapi_qc7xx_pwm_v2_channel_negative_start
    romapi_qc7xx_pwm_v2_channel_negative_start(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qc7xx_pwm_v2_channel_positive_stop(struct qc7xx_device_s *dev, uint8_t ch)
{
#ifdef romapi_qc7xx_pwm_v2_channel_positive_stop
    romapi_qc7xx_pwm_v2_channel_positive_stop(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qc7xx_pwm_v2_channel_negative_stop(struct qc7xx_device_s *dev, uint8_t ch)
{
#ifdef romapi_qc7xx_pwm_v2_channel_negative_stop
    romapi_qc7xx_pwm_v2_channel_negative_stop(dev, ch);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qc7xx_pwm_v2_int_enable(struct qc7xx_device_s *dev, uint32_t int_en, bool enable)
{
#ifdef romapi_qc7xx_pwm_v2_int_enable
    romapi_qc7xx_pwm_v2_int_enable(dev, int_en, enable);
#else
    uint32_t reg_base;
...
void qc7xx_pwm_v2_int_clear(struct qc7xx_device_s *dev, uint32_t int_clear)
{
#ifdef romapi_qc7xx_pwm_v2_int_clear
    romapi_qc7xx_pwm_v2_int_clear(dev, int_clear);
#else
    putreg32(int_clear, dev->reg_base + PWM_MC0_INT_CLEAR_OFFSET);
#endif
}

uint32_t qc7xx_pwm_v2_get_intstatus(struct qc7xx_device_s *dev)
{
#ifdef romapi_qc7xx_pwm_v2_get_intstatus
    return romapi_qc7xx_pwm_v2_get_intstatus(dev);
#else
    uint32_t reg_base;
...
int qc7xx_pwm_v2_feature_control(struct qc7xx_device_s *dev, int cmd, size_t arg)
{
#ifdef romapi_qc7xx_pwm_v2_feature_control
    return romapi_qc7xx_pwm_v2_feature_control(dev, cmd, arg);
#else
    int ret = 0;
    uint32_t reg_base;
    uint32_t regval;
