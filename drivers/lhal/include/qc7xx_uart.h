...
#ifndef _QC7XX_UART_H
#define _QC7XX_UART_H
 ...
 */
int qc7xx_uart_putchar(struct qc7xx_device_s *dev, int ch);
 ...
 */
int qc7xx_uart_getchar(struct qc7xx_device_s *dev);
 ...
 * @return A negated errno value on failure.
 */
int qc7xx_uart_put(struct qc7xx_device_s *dev, uint8_t *data, uint32_t len);
 ...
 * @return A negated errno value on failure.
 */
int qc7xx_uart_put_block(struct qc7xx_device_s *dev, uint8_t *data, uint32_t len);
/**
 ...
 */
int qc7xx_uart_get(struct qc7xx_device_s *dev, uint8_t *data, uint32_t len);
