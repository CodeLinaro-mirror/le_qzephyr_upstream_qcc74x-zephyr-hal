...
#define USB_MVDMA_CMPLT_F4  (1 << 5U)
#define USB_MVDMA_CMPLT_F5  (1 << 6U)
#define USB_MVDMA_CMPLT_F6  (1 << 7U)
#define USB_MVDMA_CMPLT_F7  (1 << 8U)
...
#define USB_MVDMA_ERROR_F4  (1 << 21U)
#define USB_MVDMA_ERROR_F5  (1 << 22U)
#define USB_MVDMA_ERROR_F6  (1 << 23U)
#define USB_MVDMA_ERROR_F7  (1 << 24U)
