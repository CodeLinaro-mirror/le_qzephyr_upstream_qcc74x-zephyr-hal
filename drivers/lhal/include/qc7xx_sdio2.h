...
#ifndef _QC7XX_SDIO2_H
#define _QC7XX_SDIO2_H
...
typedef struct
{
    ...
    void *buff;
    void *user_arg;
} qc7xx_sdio2_trans_desc_t;

typedef void (*qc7xx_sdio2_irq_cb_t)(void *arg, uint32_t irq_event, qc7xx_sdio2_trans_desc_t *trans_desc);
