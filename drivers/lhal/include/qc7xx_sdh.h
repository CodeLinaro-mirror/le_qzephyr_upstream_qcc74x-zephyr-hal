...
#ifndef _QC7XX_SDH_H_
#define _QC7XX_SDH_H_
...
struct qc7xx_sdh_data_tranfer_s {
    void *address;
    uint32_t length;
    bool int_en;
};
...
struct qc7xx_sdh_adma2_hw_desc_s {
    uint16_t attribute;
...
struct qc7xx_sdh_data_cfg_s {
    ...
    struct qc7xx_sdh_data_tranfer_s *adma_tranfer; /*!< The address of adma_tranfer descriptors. */
    ...
    struct qc7xx_sdh_adma2_hw_desc_s *adma2_hw_desc; /*!< The address of hardware descriptors. */
