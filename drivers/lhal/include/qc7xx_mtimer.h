...
#ifndef _QC7XX_MTIMER_H
#define _QC7XX_MTIMER_H
 ...
 * @return frequence
 */
uint32_t qc7xx_mtimer_get_freq(void);
 ...
 */
void qc7xx_mtimer_delay_ms(uint32_t time);
 ...
 * @param [in] time delay time
 */
void qc7xx_mtimer_delay_us(uint32_t time);
 ...
 * @return time with us
 */
uint64_t qc7xx_mtimer_get_time_us(void);
 ...
 * @return time with ms
 */
uint64_t qc7xx_mtimer_get_time_ms(void);
