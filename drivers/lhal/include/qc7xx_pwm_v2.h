...
#ifndef _QC7XX_PWM_V2_H
#define _QC7XX_PWM_V2_H
...
#define IS_PWM_CLK_SOURCE(type)   (((type) == QC7XX_SYSTEM_PBCLK) || \
                                  ((type) == QC7XX_SYSTEM_XCLK) || \
                                  ((type) == QC7XX_SYSTEM_32K_CLK))
 ...
 */
struct qc7xx_pwm_v2_channel_config_s {
