...
#ifndef _QC7XX_AUDAC_H
#define _QC7XX_AUDAC_H
 ...
 */
struct qc7xx_audac_init_config_s {
 ...
 */
struct qc7xx_audac_volume_config_s {
    bool mute_ramp_en;
...
int qc7xx_audac_init(struct qc7xx_device_s *dev, const struct qc7xx_audac_init_config_s *config);

int qc7xx_audac_volume_init(struct qc7xx_device_s *dev, const struct qc7xx_audac_volume_config_s *vol_cfg);

int qc7xx_audac_link_rxdma(struct qc7xx_device_s *dev, bool enable);

int qc7xx_audac_int_mask(struct qc7xx_device_s *dev, uint32_t mask);

int qc7xx_audac_int_unmask(struct qc7xx_device_s *dev, uint32_t int_sts);

int qc7xx_audac_get_intstatus(struct qc7xx_device_s *dev);

int qc7xx_audac_int_clear(struct qc7xx_device_s *dev, uint32_t int_clear);

int qc7xx_audac_feature_control(struct qc7xx_device_s *dev, int cmd, size_t arg);
