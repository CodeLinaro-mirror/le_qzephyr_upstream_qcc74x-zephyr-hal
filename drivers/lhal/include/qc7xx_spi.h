...
#ifndef QC7XX_SPI_IDEL_DATA
#define QC7XX_SPI_IDEL_DATA 0xFFFFFFFF
#endif
 ...
 * @return receive data
 */
uint32_t qc7xx_spi_poll_send(struct qc7xx_device_s *dev, uint32_t data);
 ...
 */
int qc7xx_spi_poll_exchange(struct qc7xx_device_s *dev, const void *txbuffer, void *rxbuffer, size_t nbytes);
