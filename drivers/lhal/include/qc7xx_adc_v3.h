...
#ifndef _QC7XX_ADC_V3_H
#define _QC7XX_ADC_V3_H
 ...
 */
struct qc7xx_adc_common_config_s {
    uint8_t clk_div;
    uint8_t mode;
 ...
 */
struct qc7xx_adc_watchdog_config_s {
    uint8_t enable;
    uint8_t adc_id;
 ...
 *
 * @param [in] dev device handle
 * @param [in] buffer pointer to adc original value from qc7xx_adc_read_raw or qc7xx_adc_read_raw_inject api
