...
#ifndef _QC7XX_AUADC_H
#define _QC7XX_AUADC_H
 ...
 */
struct qc7xx_auadc_init_config_s {
 ...
 */
struct qc7xx_auadc_adc_init_config_s {
...
#if (AUADC_ANALOG_ADC_SUPPORT)
int qc7xx_auadc_adc_init(struct qc7xx_device_s *dev, const struct qc7xx_auadc_adc_init_config_s *config);
#endif
