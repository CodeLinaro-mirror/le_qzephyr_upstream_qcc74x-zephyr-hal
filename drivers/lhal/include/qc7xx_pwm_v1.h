...
#ifndef _QC7XX_PWM_V1_H
#define _QC7XX_PWM_V1_H
 ...
 */
struct qc7xx_pwm_v1_channel_config_s {
    uint8_t clk_source;
    uint16_t clk_div;
    uint16_t period;
};
 ...
 */
void qc7xx_pwm_v1_channel_init(struct qc7xx_device_s *dev, uint8_t ch, const struct qc7xx_pwm_v1_channel_config_s *config);
 ...
 * @param [in] ch channel number
 */
void qc7xx_pwm_v1_channel_deinit(struct qc7xx_device_s *dev, uint8_t ch);
 ...
 * @param [in] ch channel number
 */
void qc7xx_pwm_v1_start(struct qc7xx_device_s *dev, uint8_t ch);
 ...
 * @param [in] ch channel number
 */
void qc7xx_pwm_v1_stop(struct qc7xx_device_s *dev, uint8_t ch);
 ...
 */
void qc7xx_pwm_v1_set_period(struct qc7xx_device_s *dev, uint8_t ch, uint16_t period);
 ...
 */
void qc7xx_pwm_v1_channel_set_threshold(struct qc7xx_device_s *dev, uint8_t ch, uint16_t low_threhold, uint16_t high_threhold);
 ...
 */
void qc7xx_pwm_v1_int_enable(struct qc7xx_device_s *dev, uint8_t ch, bool enable);
 ...
 */
uint32_t qc7xx_pwm_v1_get_intstatus(struct qc7xx_device_s *dev);
 ...
 */
void qc7xx_pwm_v1_int_clear(struct qc7xx_device_s *dev, uint32_t int_clear);
 ...
 */
int qc7xx_pwm_v1_feature_control(struct qc7xx_device_s *dev, uint8_t ch, int cmd, size_t arg);
