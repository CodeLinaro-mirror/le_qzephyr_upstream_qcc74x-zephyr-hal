...
#ifndef _QC7XX_SEC_PKA_H
#define _QC7XX_SEC_PKA_H
...
void qc7xx_pka_lmod2n(struct qc7xx_device_s *dev,
                     uint8_t s0_regindex,
                     uint8_t s0_regsize,
                     uint8_t d0_regindex,
                     uint8_t d0_regsize,
...
void qc7xx_pka_ldiv2n(struct qc7xx_device_s *dev,
                     uint8_t s0_regindex,
                     uint8_t s0_regsize,
                     uint8_t d0_regindex,
                     uint8_t d0_regsize,
...
void qc7xx_pka_lmul2n(struct qc7xx_device_s *dev,
                     uint8_t s0_regindex,
                     uint8_t s0_regsize,
                     uint8_t d0_regindex,
                     uint8_t d0_regsize,
...
void qc7xx_pka_ldiv(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_lsqr(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_lmul(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_lsub(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_ladd(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
uint8_t qc7xx_pka_lcmp(struct qc7xx_device_s *dev,
                      uint8_t s0_regindex,
                      uint8_t s0_regsize,
                      uint8_t s1_regindex,
                      uint8_t s1_regsize);

void qc7xx_pka_minv(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_mexp(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_msqr(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_mmul(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_mrem(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_msub(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_madd(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_regsize(struct qc7xx_device_s *dev,
                      uint8_t s0_regindex,
                      uint8_t s0_regsize,
                      uint8_t d0_regindex,
                      uint8_t d0_regsize,
...
void qc7xx_pka_movdat(struct qc7xx_device_s *dev,
                     uint8_t s0_regindex,
                     uint8_t s0_regsize,
                     uint8_t d0_regindex,
                     uint8_t d0_regsize,
...
void qc7xx_pka_nlir(struct qc7xx_device_s *dev,
                   uint8_t s0_regindex,
                   uint8_t s0_regsize,
                   uint8_t d0_regindex,
                   uint8_t d0_regsize,
...
void qc7xx_pka_slir(struct qc7xx_device_s *dev,
                   uint8_t regindex,
                   uint8_t regsize,
                   uint32_t data,
                   uint8_t lastop);

void qc7xx_pka_clir(struct qc7xx_device_s *dev,
                   uint8_t regindex,
                   uint8_t regsize,
                   uint16_t size,
                   uint8_t lastop);

void qc7xx_pka_write(struct qc7xx_device_s *dev,
                    uint8_t regindex,
                    uint8_t regsize,
                    const uint32_t *data,
                    uint16_t size,
...
void qc7xx_pka_read(struct qc7xx_device_s *dev,
                   uint8_t regindex,
                   uint8_t regsize,
                   uint32_t *data,
                   uint16_t size);

void qc7xx_pka_gf2mont(struct qc7xx_device_s *dev,
                      uint8_t s_regindex,
                      uint8_t s_regsize,
                      uint8_t d_regindex,
                      uint8_t d_regsize,
...
void qc7xx_pka_mont2gf(struct qc7xx_device_s *dev,
                      uint8_t s_regindex,
                      uint8_t s_regsize,
                      uint8_t d_regindex,
                      uint8_t d_regsize,
