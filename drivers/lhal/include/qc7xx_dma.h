 ...
 */
struct qc7xx_dma_channel_lli_pool_s {
    uint32_t src_addr;
    uint32_t dst_addr;
    uint32_t nextlli;
    union qc7xx_dma_lli_control_s control;
};
 ...
 */
struct qc7xx_dma_channel_lli_transfer_s {
    uint32_t src_addr;
    uint32_t dst_addr;
    uint32_t nbytes;
};
 ...
 */
struct qc7xx_dma_channel_config_s {
    uint8_t direction;
    uint32_t src_req;
    uint32_t dst_req;
 ...
 */
int qc7xx_dma_channel_lli_reload(struct qc7xx_device_s *dev,
                                struct qc7xx_dma_channel_lli_pool_s *lli_pool, uint32_t max_lli_count,
                                struct qc7xx_dma_channel_lli_transfer_s *transfer, uint32_t count);
