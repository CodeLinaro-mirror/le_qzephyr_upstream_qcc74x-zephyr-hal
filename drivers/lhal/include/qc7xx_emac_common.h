...
#ifndef _QC7XX_EMAC_COMMON_H
#define _QC7XX_EMAC_COMMON_H
...
struct qc7xx_emac_trans_desc_s {
...
typedef void (*qc7xx_emac_irq_cb_t)(void *arg, uint32_t irq_event, struct qc7xx_emac_trans_desc_s *trans_desc);
