 ...
 * @file mac_types.h
 *
 * @brief MAC related types.
 *
 * This file should contains all types, definitions that would be required for MACSW
 ...
 * @details
 *
 * - Types and definitions that are used by the MACSW firmware and integration layers
 ****************************************************************************************
 */
#include "export/common/co_int.h"
#include "export/common/co_bool.h"
#include "export/common/co_bit.h"
