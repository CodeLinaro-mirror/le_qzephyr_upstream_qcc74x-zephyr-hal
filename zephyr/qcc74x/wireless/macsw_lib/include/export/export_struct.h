...
struct_func_dcl(twt_setup_ind, uint8_t, resp_type);
struct_func_dcl(twt_setup_ind, uint8_t, sta_idx);
struct_func_dcl(twt_setup_ind, uint8_t, vif_idx);
struct_func_dcl(twt_setup_ind, uint8_t, flow_id);
struct_func_dcl(twt_setup_ind, uint8_t, trigger);
struct_func_dcl(twt_setup_ind, uint8_t, implicit);
struct_func_dcl(twt_setup_ind, uint8_t, dialog_token);
...
void twt_statusget_cfm_get_conf(void *pa, void *cfm, uint8_t flow_conf_max);
