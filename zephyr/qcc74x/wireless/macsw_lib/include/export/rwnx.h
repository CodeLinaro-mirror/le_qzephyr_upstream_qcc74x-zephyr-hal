 ...
 ****************************************************************************************
 */
struct rwnxl_sleep_check_result {
    bool cpu_can_sleep;
    bool queue_sent_empty;
    bool queue_saved_empty;
    bool ps_allowed;
    bool tx_allowed;
    bool machw_allowed;
};

int rwnxl_ps_sleep_check_quiet(struct rwnxl_sleep_check_result *result);
 ...
 ****************************************************************************************
 */
int rwnxl_pds_wifi_config(qc7xx_lp_fw_cfg_t *pcfg);
 ...
 ****************************************************************************************
 */
void rwnxl_resume_wifi(qc7xx_lp_fw_cfg_t *pcfg);

/**
 ****************************************************************************************
 * @brief This function notifies Wi-Fi resume from a non-ISR wake path.
 *
 ****************************************************************************************
 */
void rwnxl_resume_wifi_not_isr(qc7xx_lp_fw_cfg_t *pcfg);
